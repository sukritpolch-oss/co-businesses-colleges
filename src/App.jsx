...
5. **กฎเหล็กการตั้งชื่องาน (บังคับใช้เคร่งครัด)**: 
...
8. **กฎเหล็กการตอบกลับ (สำคัญที่สุด)**: 
          ...
          properties: {
            subTasks: {
              ...
              items: {
                type: "OBJECT",
                properties: {
                  subjectTaskId: { type: "STRING", description: "รหัสอ้างอิงจากรายวิชา (ถ้ามี) ตอบเฉพาะรหัสเท่านั้น ห้ามมีข้อความอื่น" },
                  workplaceName: { type: "STRING", description: "ชื่องานย่อย สั้น กระชับ เป็นคำกริยา ห้ามมีคำอธิบายความหมายเพิ่มเติม ห้ามเขียนเรียงความ (ไม่เกิน 100 ตัวอักษร)" },
                  detailed_steps: {
                    type: "ARRAY",
                    items: {
                      type: "OBJECT",
                      properties: {
                        subjectTaskId: { type: "STRING", description: "รหัสอ้างอิงจากรายวิชา (ถ้ามี) ตอบเฉพาะรหัสเท่านั้น" },
                        step_text: { type: "STRING", description: "ข้อความขั้นตอนการปฏิบัติงาน สั้น กระชับ ขึ้นต้นด้วยคำกริยา ห้ามอธิบายยาวเยิ่นเย้อ" },
                        objectives: {
                        ...
                        equipment: { type: "STRING", description: "ชื่อสื่อและอุปกรณ์แบบสั้นๆ" }
                      }
                    }
                  }
                }
...
- **กฎเหล็ก**: ต้องตอบข้อมูลเป็น **ภาษาไทยเท่านั้น** กระชับและตรงประเด็น **ห้าม** อธิบายกระบวนการคิด หรือเขียนเรียงความภาษาอังกฤษ (เช่น ห้ามมีคำว่า Mapping: ...) ลงมาในเนื้อหาเด็ดขาด`;
          ...
          properties: {
            detailed_steps: {
              ...
              items: {
                ...
                properties: {
                  subjectTaskId: { type: "STRING", description: "รหัสอ้างอิงจากรายวิชา (ถ้ามี) ตอบเฉพาะรหัสเท่านั้น ห้ามมีข้อความอื่น" },
                  step_text: { type: "STRING", description: "ขั้นตอนการปฏิบัติงาน สั้น กระชับ ขึ้นต้นด้วยคำกริยา ห้ามอธิบายความหมายเพิ่มเติม" },
                  ...
                  equipment: { type: "STRING", description: "รายชื่อสื่อและอุปกรณ์แบบสั้นๆ" }
                }
              }
            }
          }
