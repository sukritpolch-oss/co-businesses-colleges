...
1. แตกเป็น "งานย่อย" 4-6 งาน และสำหรับแต่ละงานย่อยต้องเขียนขั้นตอนการปฏิบัติงานให้ละเอียดมากพอสำหรับใช้ใน DVE-04-06 (ฝอ.2)
- งานย่อยแต่ละงานต้องมี objectiveRows ครบ 5 ขั้น ได้แก่ ขั้นเตรียม, ขั้นปฏิบัติงาน, ขั้นตรวจสอบผลงาน, ขั้นเก็บเครื่องมือและอุปกรณ์, ขั้นทำความสะอาด
- ใน objectiveRows.steps ของแต่ละขั้น ต้องมีขั้นตอนย่อยอย่างน้อย 3-5 ข้อ
- รวมแล้วงานย่อย 1 งานควรมีขั้นตอนย่อยไม่น้อยกว่า 15 ข้อ
- ห้ามเขียนสั้นแบบ 1.1 ระบุเครื่องมือ 1.2 ตรวจสอบจำนวนเครื่องมือ
- ต้องเขียนให้เห็นลำดับการทำงานจริง ตั้งแต่เตรียมพื้นที่ เตรียมเครื่องมือ ตรวจสอบความปลอดภัย ปฏิบัติงาน ตรวจสอบคุณภาพ แก้ไขข้อบกพร่อง บันทึกผล จัดเก็บ และทำความสะอาด
- แต่ละขั้นตอนย่อยต้องเป็นประโยคปฏิบัติที่ชัดเจน ขึ้นต้นด้วยคำกริยา และมีกรรม/เป้าหมายของงาน
- ห้ามใช้ถ้อยคำกว้าง ๆ เช่น "ทำงานตามขั้นตอน", "ตรวจสอบให้เรียบร้อย", "ปฏิบัติงานให้ถูกต้อง" โดยไม่ระบุรายละเอียด
...
- งานย่อย 1 งาน ให้มี objectiveRows 5 รายการตาม 5 ขั้น
- ใน objectiveRows แต่ละรายการ ต้องมี steps เป็น array เสมอ
- steps คือขั้นตอนย่อยของขั้นนั้น ๆ เช่น ขั้นเตรียมมี 1.1, 1.2, 1.3 ได้
- ห้ามนำขั้นตอนทั้งหมดไปรวมไว้ใน detailed_steps เพียงอย่างเดียว
- objectiveRows ต้องมี 5 รายการตามลำดับนี้เท่านั้น:
  1) ขั้นเตรียม
  2) ขั้นปฏิบัติงาน
  3) ขั้นตรวจสอบผลงาน
  4) ขั้นเก็บเครื่องมือและอุปกรณ์
  5) ขั้นทำความสะอาด
  - objectiveRows ทั้ง 5 รายการต้องครอบคลุมระดับความสามารถอย่างน้อย 4 ด้าน คือ K, S, A และ Ap
- ต้องมีอย่างน้อย 1 รายการที่ domain เป็น "Ap"
- ห้ามตอบเฉพาะ K, S, A โดยไม่มี Ap
- ขั้นที่เหมาะสมกับ Ap คือ ขั้นตรวจสอบผลงาน ขั้นเก็บเครื่องมือและอุปกรณ์ หรือขั้นทำความสะอาด เมื่อเขียนเป็นการประยุกต์ใช้ความรู้และทักษะเพื่อแก้ปัญหา ปรับใช้ หรือเลือกวิธีปฏิบัติให้เหมาะสม
...
5. งานปฏิบัติการ ต้องมีขั้นตอนแรกคือ "จัดเตรียมเครื่องมือ/วัตถุดิบ" และขั้นตอนสุดท้ายคือ "จัดเก็บและทำความสะอาด" เสมอ
...
- ให้ระบุเฉพาะข้อมูลสั้นๆ กระชับ ตรงประเด็นลงใน JSON เท่านั้น ห้ามเขียนเรียงความภาษาอังกฤษมาเด็ดขาด`;
      ...
      const newSubTasks = safeSubTasks.map((st, i) => {
        ...
        const rawObjectiveRows = Array.isArray(st.objectiveRows) ? st.objectiveRows : [];
...
1. ต้องเขียนขั้นตอนการปฏิบัติงานให้ครอบคลุม 5 ขั้นตามลำดับนี้เท่านั้น
  1) ขั้นเตรียม
  2) ขั้นปฏิบัติงาน
  3) ขั้นตรวจสอบผลงาน
  4) ขั้นเก็บเครื่องมือและอุปกรณ์
...
2. ใน objectiveRows ต้องมี 5 รายการเสมอ โดยแต่ละรายการต้องมี steps เป็น array
- objectiveRows[0].stage = "ขั้นเตรียม"
- objectiveRows[1].stage = "ขั้นปฏิบัติงาน"
- objectiveRows[2].stage = "ขั้นตรวจสอบผลงาน"
- objectiveRows[3].stage = "ขั้นเก็บเครื่องมือและอุปกรณ์"
- objectiveRows[4].stage = "ขั้นทำความสะอาด"

3. ความละเอียดของขั้นตอน
- แต่ละ objectiveRows.steps ต้องมีอย่างน้อย 3-5 ขั้นตอนย่อย
- รวมทั้งงานย่อยต้องมีขั้นตอนย่อยอย่างน้อย 15 ขั้นตอน
- ขั้นปฏิบัติงานต้องละเอียดที่สุด และต้องมีอย่างน้อย 5 ขั้นตอนย่อย
- ขั้นตรวจสอบผลงานต้องระบุวิธีตรวจ เกณฑ์ตรวจ หรือจุดที่ต้องตรวจให้ชัดเจน
- ขั้นเก็บเครื่องมือและอุปกรณ์ต้องระบุการตรวจนับ ทำความสะอาด จัดเก็บ และรายงานความชำรุด
- ขั้นทำความสะอาดต้องระบุพื้นที่ วัสดุเหลือใช้ ของเสีย และการคืนสภาพพื้นที่

4. รูปแบบการเขียน steps
...
- ให้เขียนเป็น "ทำความสะอาดพื้นที่ปฏิบัติงานและคัดแยกเศษวัสดุตามประเภทของเสีย"
- ห้ามนำขั้นตอนทั้งหมดไปรวมไว้ใน detailed_steps เพียงอย่างเดียว
...
- ขั้นสุดท้ายต้องเป็นการทำความสะอาดหรือคืนสภาพพื้นที่ให้เรียบร้อย
