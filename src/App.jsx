...
const App = () => {
  ...
  const remapAllWorkplaceTasks = async () => {
    ...
    try {
      ...
      **กฎเหล็กการจับคู่:**
      1. นำงานสถานประกอบการแต่ละข้อ ไปพิจารณาเปรียบเทียบความหมายและผลลัพธ์ของงานกับพูลงานด้านบน โดยต้องพิจารณาทั้ง "คำกริยา" (Action) และ "เป้าหมาย/สิ่งที่ถูกกระทำ" (Object) ประกอบกันเสมอ (เช่น "แก้ไขข้อขัดข้องเครื่องยนต์" ต้องคู่กับงานแนว "ซ่อม/ปรับแต่ง/บำรุงรักษา เครื่องยนต์")
      2. ให้ถือว่าคำกริยาและกลุ่มคำต่อไปนี้มีความสอดคล้องหรือความหมายไปในทิศทางเดียวกัน สามารถนำมาจับคู่กันได้:
         - กลุ่มแก้ปัญหา/ซ่อมบำรุง: แก้ไขข้อขัดข้อง, ตรวจซ่อม, ซ่อมบำรุง, ซ่อมแซม, ซ่อม, แก้ปัญหา, แก้ไข, ปรับปรุง, ปรับแต่ง, ปรับตั้ง, ปรับ, เปลี่ยน(อุปกรณ์/อะไหล่)
         - กลุ่มจัดการ/ตรวจสอบ: ตรวจสอบ, สอบทาน, เช็ค, ทดสอบ, วิเคราะห์, จัดการ, บริหาร, คัดแยก, บรรจุ
  ...
  const analyzeWorkplaceMainTask = async (taskId) => {
    ...
    try {
     const systemPrompt = `วิเคราะห์งานหลัก: "${taskToAnalyze.name}" 
      ...
      - ให้จับคู่โดยพิจารณาจาก "ลักษณะการปฏิบัติงาน" และ "เป้าหมาย/สิ่งที่ถูกกระทำ" ประกอบกันเสมอ (เช่น "แก้ไขข้อขัดข้องเครื่องยนต์" ต้องคู่กับงานแนว "ซ่อม/ปรับแต่ง/บำรุงรักษา เครื่องยนต์") โดยอนุโลมให้กลุ่มคำต่อไปนี้สอดคล้องกัน:
        * แก้ปัญหา/ซ่อมบำรุง: แก้ไขข้อขัดข้อง, ตรวจซ่อม, ซ่อมบำรุง, ซ่อมแซม, ซ่อม, แก้ปัญหา, แก้ไข, ปรับปรุง, ปรับแต่ง, ปรับตั้ง, เปลี่ยน
        * จัดการ/ตรวจสอบ: ตรวจสอบ, สอบทาน, เช็ค, ทดสอบ, วิเคราะห์, จัดการ, บริหาร, คัดแยก, บรรจุ
        * วางแผน/สร้างสรรค์: ออกแบบ, วางแผน, วางโครงสร้าง, คิดค้น, ประดิษฐ์, กำหนด
        * ลงมือทำ/ดำเนินการ: ผลิต, ดำเนินการ, ปฏิบัติ, ประกอบ, ติดตั้ง, จัดทำ, จัดเตรียม, ตัด, เย็บ
      ...
      6. งานปฏิบัติการช่าง/วิชาชีพ ต้องมีขั้นตอนแรกคือ "จัดเตรียมเครื่องมือ" และขั้นตอนสุดท้ายคือ "จัดเก็บและทำความสะอาด" เสมอ
