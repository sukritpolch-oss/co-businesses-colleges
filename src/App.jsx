...
- ระดับ K/S/A/Ap ต้องสัมพันธ์กับคำกริยา:
  K1 = บอก, ระบุ, เลือก, จำแนกข้อมูลพื้นฐาน
  K2 = อธิบาย, เปรียบเทียบ, วิเคราะห์เหตุผล
  K3 = ประเมิน, สรุปผล, วางหลักเกณฑ์
  S1 = ปฏิบัติตามขั้นตอนพื้นฐาน
  S2 = ปฏิบัติได้ถูกต้อง คล่องแคล่ว ตรวจสอบงานได้
  S3 = แก้ปัญหา ปรับปรุง หรือควบคุมงานซับซ้อนได้
  A1 = ปฏิบัติตามกฎ ระเบียบ ความปลอดภัย
  A2 = รับผิดชอบ ระมัดระวัง ให้ความร่วมมือ
  A3 = เป็นแบบอย่าง เสนอแนะ ปรับปรุงพฤติกรรมการทำงาน
  Ap1 = ประยุกต์ใช้ในสถานการณ์ปกติ
  Ap2 = ประยุกต์ใช้กับปัญหาหรือเงื่อนไขที่แตกต่าง
  Ap3 = วางแผน ปรับปรุง ตัดสินใจ หรือแก้ปัญหาเชิงระบบ
- ห้ามกำหนดระดับสูง เช่น Ap3 หากข้อความเป็นเพียงการระบุหรือรวบรวมข้อมูลพื้นฐาน
