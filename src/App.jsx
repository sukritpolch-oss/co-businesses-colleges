...
const App = () => {
  ...
  const remapAllWorkplaceTasks = async () => {
    ...
    try {
      ...
      **กฎเหล็กการจับคู่:**
      1. นำงานสถานประกอบการแต่ละข้อ ไปพิจารณาเปรียบเทียบความหมายและผลลัพธ์ของงานกับพูลงานด้านบน
      2. ให้ถือว่าคำกริยาในกลุ่มเดียวกันต่อไปนี้มีความสอดคล้องหรือมีความหมายไปในทิศทางเดียวกัน สามารถนำมาจับคู่กันได้:
  ...
  const analyzeWorkplaceMainTask = async (taskId) => {
    ...
    try {
      ...
      - ให้จับคู่โดยพิจารณาจาก "ลักษณะการปฏิบัติงานที่คล้ายคลึงกัน" โดยอนุโลมให้คำกริยาในกลุ่มต่อไปนี้มีความหมายสอดคล้องกัน:
        ...
        * จัดการ/ตรวจสอบ: ตรวจสอบ, สอบทาน, เช็ค, จัดการ, บริหาร, ซ่อมแซม, ซ่อม, แก้ไข, คัดแยก, บรรจุ, ปรับแต่ง, ปรับตั้ง
