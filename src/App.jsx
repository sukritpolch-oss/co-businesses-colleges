                  ...
                  <div className="flex items-center gap-4 mb-6 font-serif">
                    ...
                    {sub.isAnalyzed && (
                      <button
                        ...
                        className="w-full mt-3 py-3 rounded-2xl text-[11px] font-black bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg transition-all flex items-center justify-center gap-2 disabled:bg-slate-300"
                      >
