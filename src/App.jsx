...
const App = () => {
  ...
  const runSubjectAnalysis = async (sub) => {
    ...
    4. ห้ามใช้คำว่า ศึกษา, เรียนรู้, ทฤษฎี, อธิบาย, บอก, ระบุ, เข้าใจ, ทราบ ในการกำหนดชื่องานหลักและงานย่อยโดยเด็ดขาด
       ให้แปลงเป็นคำกริยาทางปฏิบัติการที่ทำงานได้จริง เช่น วางแผน, กำหนด, จัดทำ, ดำเนินการ, ตรวจสอบ, วิเคราะห์, ประเมิน, ปฏิบัติ, นำเสนอ, ให้บริการ
       ตัวอย่าง: ห้ามตอบ "กำหนดตลาดเป้าหมายและอธิบายกระบวนการขายออนไลน์"
       ให้ตอบเป็น "กำหนดตลาดเป้าหมายและดำเนินกระบวนการขายออนไลน์"`;
...
- ในแต่ละ objectiveRows.steps สามารถมีขั้นตอนย่อยได้หลายขั้น เช่น 1.1, 1.2, 1.3
- แต่ละ steps ต้องเป็นประโยคบอกเล่า
- แต่ละ steps ต้องขึ้นต้นด้วยคำกริยา
- แต่ละ steps ต้องมีการกระทำเพียงอย่างเดียว
- ต้องเห็นว่าเริ่มต้นงานตรงไหนและสิ้นสุดงานตรงไหน
- ห้ามนำขั้นตอนทั้งหมดไปรวมไว้ใน detailed_steps เพียงอย่างเดียว
                          ...
                          return displaySubTasks.map((sub, sIdx) => (
                            <tr key={`${mIdx}-${sIdx}`} className="font-serif align-top">
                              ...
                              <td className="border border-black p-2 text-center font-bold align-top break-words">
                                {sub.hours ? (
                                  <>
                                    {Number((sub.hours / (config.hoursPerDay || 8)).toFixed(1))} วัน<br />
                                    <span className="text-[8pt] text-slate-600">({sub.hours} ชม.)</span>
                                  </>
                                ) : '-'}
                              </td>
                            </tr>
                        ...
                        {(() => {
                          ...
                          return (
                            <tr className="font-serif align-top bg-blue-50/30">
                              ...
                              <td className="border border-black p-2 text-center font-bold align-top break-words">
                                {activityDays} วัน<br />
                                <span className="text-[8pt] text-slate-600">({activityHours} ชม.)</span>
                              </td>
                            </tr>
                          );
                        })()}
