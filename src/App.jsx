...
// API สำหรับคลังแผนฝึกอาชีวศึกษา (VEC Hub) ใหม่!
const VEC_HUB_URL = "https://script.google.com/macros/s/AKfycbyPLA8syhsnL0KuaEM00LeQH8zQnhKwMTtSVUCPtxWmSMipZUgnAepkLvK-yPRD0OxgSQ/exec";
// API สำหรับ “คลังงานรายวิชา” เท่านั้น
// จะนำ URL จาก Apps Script มาใส่ในขั้นตอนถัดไป
const COURSE_LIBRARY_URL = "https://script.google.com/macros/s/AKfycbycZJnfkqUzuO8AA1GaAtIkQdRhorcroMDB2d2XQ7-oIRvwEV3IGIYk29iWpQCw9zKxhw/exec";
...
const vocationalCollegesByProvince = {
  "เชียงราย": [
  ...
  "ลำปาง": [
    ...
    "วิทยาลัยเกษตรและเทคโนโลยีลำปาง",
  ...
  "กรุงเทพมหานคร": [
    ...
    "วิทยาลัยเทคนิคโพธาราม (สถาบันการอาชีวศึกษา กทม.)",
  ...
  "ชัยนาท": [
    ...
    "วิทยาลัยการอาชีพชัยนาท (วิทยาลัยเกษตรและเทคโนโลยีชัยนาท)"
  ],
  "นครนายก": [
  ...
  "นครสวรรค์": [
    ...
    "วิทยาลัยการอาชีพตาคลี"
  ],
  "นนทบุรี": [
    "วิทยาลัยเทคนิคนนทบุรี",
    "วิทยาลัยการอาชีพปากเกร็ด"
  ],
  "ปทุมธานี": [
  ...
  "สมุทรปราการ": [
    ...
    "วิทยาลัยการอาชีวศึกษาปทุมธานี (สาขา)"
  ],
  "สมุทรสงคราม": [
  ...
  "อุทัยธานี": [
    ...
    "วิทยาลัยการอาชีพห้วยคต"
  ],
  "จันทบุรี": [
    "วิทยาลัยเทคนิคจันทบุรี",
    "วิทยาลัยสารพัดช่างจันทบุรี",
    "วิทยาลัยเกษตรและเทคโนโลยีจันทบุรี",
  ...
  "ราชบุรี": [
    ...
    "วิทยาลัยเทคนิคบ้านโป่ง",
    "วิทยาลัยอาชีวศึกษาราชบุรี (วิทยาลัยพยาบาลบรมราชชนนี ราชบุรี)",
  ...
  "กาฬสินธุ์": [
    "วิทยาลัยเทคนิคกาฬสินธุ์ (สังกัด มรภ.กาฬสินธุ์)",
    "วิทยาลัยเทคนิคเขาวง",
  ...
  "นครพนม": [
    "วิทยาลัยเทคนิคนครพนม (สังกัด มหาวิทยาลัยนครพนม)",
    "วิทยาลัยการอาชีพธาตุพนม",
    "วิทยาลัยการอาชีพนาหว้า",
    "วิทยาลัยการอาชีพศรีสงคราม"
  ],
  "นครราชสีมา": [
  ...
  "สกลนคร": [
    ...
    "วิทยาลัยเทคนิคบ้านม่วง",
    "วิทยาลัยอาชีวศึกษาสกลนคร",
    "วิทยาลัยเกษตรและเทคโนโลยีสกลนคร",
  ...
  "สุรินทร์": [
    ...
    "วิทยาลัยเกษตรและเทคโนโลยีสุรินทร์",
  ...
  "หนองคาย": [
    ...
    "วิทยาลัยเทคนิคโคกสำราญ",
    "วิทยาลัยอาชีวศึกษาหนองคาย",
    "วิทยาลัยการอาชีพหนองคาย",
    "วิทยาลัยการอาชีพศรีเชียงใหม่"
  ],
  "หนองบัวลำภู": [
  ...
  "นครศรีธรรมราช": [
    ...
    "วิทยาลัยการอาชีพทุ่งใหญ่",
    "วิทยาลัยการอาชีพชะอวด",
    "วิทยาลัยการอาชีพบางขัน"
  ],
  "นราธิวาส": [
    "วิทยาลัยเทคนิคนราธิวาส (สังกัด ม.นราธิวาสราชนครินทร์)",
    "วิทยาลัยการอาชีพสุไหงโก-ลก",
    "วิทยาลัยการอาชีพรามัน",
    "วิทยาลัยเกษตรและเทคโนโลยีนราธิวาส (สังกัด ม.นราธิวาสราชนครินทร์)"
  ],
  "ปัตตานี": [
  ...
  "สงขลา": [
    ...
    "วิทยาลัยเทคนิคจะนะ",
    "วิทยาลัยเทคนิคนครศรีธรรมราชสงขลา (สาขา)",
    ...
    "วิทยาลัยเทคโนโลยีและการจัดการสิงหนคร (รัตน์ประธานราษฎร์นิกร)"
  ],
  "สตูล": [
    "วิทยาลัยเทคนิคสตูล",
...
const App = () => {
  ...
  const [currentUserCollege, setCurrentUserCollege] = useState('');
  ...
  const availableColleges = useMemo(() => {
    return vocationalCollegesByProvince[authData.province] || [];
  }, [authData.province]);
  ...
  const [deleteTargetHub, setDeleteTargetHub] = useState('cloud'); // เก็บค่าว่าเป็นคลังไหน 'cloud' หรือ 'vechub'
  const [systemFeedback, setSystemFeedback] = useState({ ux: 5, ai: 5, speed: 5, reports: 5, overall: 5, suggestion: '' });
  const [isSubmittingFeedback, setIsSubmittingFeedback] = useState(false);
  const [vecHubData, setVecHubData] = useState([]);
  // --- Course Library States ---
  const [courseLibraryData, setCourseLibraryData] = useState([]);
  const [isLoadingCourseLibrary, setIsLoadingCourseLibrary] = useState(false);
  ...
  const [pendingCourseImportItems, setPendingCourseImportItems] = useState([]);
  // --- Work data states ---
  ...
  const cleanTaskName = (name) => {
    ...
    let cleaned = name
      .replace(/ศึกษา|เรียนรู้|ทฤษฎี|อธิบาย|บอก|ระบุ|เข้าใจ|ทราบ/g, '')
      .replace(/และกระบวนการ/g, 'และดำเนินกระบวนการ')
      .trim();
    // นำเงื่อนไขที่ตัดคำว่า "การ" ออกไปแล้ว เพื่อให้คำว่า "การ" ถูกลบเฉพาะชื่อวิชา ไม่เกี่ยวกับชื่องาน
    return cleaned;
  };
  const cleanWorkplaceTaskName = (name) => {
    if (!name) return '';

    return String(name)
      .replace(/รหัสวิชา[\s\S]*/g, '')
      .replace(/description[\s\S]*/gi, '')
      .replace(/emoji_objects[\s\S]*/gi, '')
      .replace(/target[\s\S]*/gi, '')
      .replace(/ผลลัพธ์การเรียนรู้[\s\S]*/g, '')
      .replace(/จุดประสงค์รายวิชา[\s\S]*/g, '')
      .replace(/สมรรถนะรายวิชา[\s\S]*/g, '')
      .replace(/คำอธิบายรายวิชา[\s\S]*/g, '')
      .replace(/\s+/g, ' ')
      .trim()
      .slice(0, 120);
  };
  ...
  useEffect(() => {
    ...
    if (savedSession) {
      try {
        ...
        setCurrentUserCollege(userData.collegeName || '');
        setCurrentUserDepartment(userData.department || '');
        setCurrentUserName(userData.trainerName || '');
        resetWorkspaceData();
  ...
  const handleRegisterProvinceChange = (province) => {
    setAuthData(prev => ({
      ...prev,
      province: province,
      college: ''
  ...
  const handleRegisterCollegeChange = (value) => {
    if (value === '__custom__') {
  ...
  const submitRegister = async (e) => {
    ...
    if (!authData.province) {
      return setLoginError('กรุณาเลือกจังหวัด');
    }

    if (
      authData.role !== 'ครูฝึกในสถานประกอบการ' &&
      !authData.college?.trim()
    ) {
      return setLoginError('กรุณาเลือกหรือระบุชื่อวิทยาลัย');
    }

    if (
      authData.role === 'ครูฝึกในสถานประกอบการ' &&
      !authData.companyName?.trim()
    ) {
  ...
  const submitLogin = async (e) => {
    ...
    setCurrentUserCollege(userByEmail.college || '');
    setCurrentUserDepartment(userByEmail.department || '');
    setCurrentUserName(trainerName);
  ...
  // --- ฟังก์ชันนำเข้าข้อมูลจาก VEC Hub (โหลดแบบเต็มโปรเจกต์) ---
  const handleVecHubImport = (item) => {
    try {
      ...
      const currentHasData =
        ...
        subjects.some(s => s.isAnalyzed || s.name || s.description);

      if (currentHasData) {
        setPendingDveData(parsedData);
      ...
      console.error(e);
      showStatus("เกิดข้อผิดพลาดในการโหลดข้อมูลจาก VEC Hub");
    }
  };
    ...
    const newIncomingTasks = incomingTasks.map((t, i) => ({
      ...
      subTasks: Array.isArray(t.subTasks)
        ? t.subTasks.map((st, si) => ({
          ...st,
          id: st.id || `W${Date.now().toString().slice(-4)}-${i}-${si}`,
          detailed_steps: Array.isArray(st.detailed_steps)
            ? st.detailed_steps.map(step => ({ ...step }))
            : []
        }))
        : []
    }));
  ...
  const handleJobCompanyUpload = (e) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        if (importedTasks.length > 0) {
          const normalizedTasks = importedTasks
            .filter(t => t !== null && t !== undefined) // กรองตัวที่พังทิ้ง
            .map(t => {
              // จัดรูปแบบให้เป็น Object และบังคับสถานะ isConfirmed เป็น true เสมอ (ล็อคข้อมูล)
              let taskObj = typeof t === 'string' ? { name: t, subTasks: [] } : { ...t };
              return { ...taskObj, isConfirmed: true };
            });

          // นำข้อมูลเข้าสู่ระบบแบบ "ต่อท้าย" (append) ทันที โดยไม่เรียกหน้าต่างแจ้งเตือน
          executeApplyDveData(normalizedTasks, 'append');
      ...
      // ล้างค่า input เผื่อต้องการอัปโหลดไฟล์เดิมซ้ำ
  ...
  const shareToCloud = async () => {
    ...
    // --- ส่วนที่เพิ่มใหม่: บังคับว่าต้องมีชื่องานหลักอย่างน้อย 1 งานที่กรอกข้อมูลแล้ว ---
    const hasValidTask = workplaceMainTasks.length > 0 && workplaceMainTasks.some(t => t.name && t.name.trim() !== '');
    if (!hasValidTask) {
      return showStatus("กรุณาระบุ 'ชื่องานหลัก' อย่างน้อย 1 งานก่อนแชร์เข้าสู่คลังส่วนกลาง");
    }
    // ----------------------------------------------------------------------
    ...
    try {
      ...
      // สร้างข้อความสรุปชื่องานหลัก โดยกรองเอาเฉพาะงานที่มีชื่อจริงๆ
      const validTasks = workplaceMainTasks.filter(t => t.name && t.name.trim() !== '');
      const mainTaskSummary = validTasks.map((t, idx) => `${idx + 1}. ${t.name.trim()}`).join(' | ');
      ...
      const payload = {
        ...
        level: config.level,
        planName: `แผนฝึกอาชีพ ${config.companyName}`, // <-- แก้ไขบรรทัดนี้
  ...
  // --- VEC Hub Logic ---
  const fetchVecHubData = async () => {
    try {
      const response = await fetch(VEC_HUB_URL);
      const data = await response.json();
      data.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));
      setVecHubData(data);
    } catch (err) {
      console.error("Fetch VEC Hub data error:", err);
    }
  };

  useEffect(() => {
    if (activeTab === 'vechub' && isAuthenticated) {
      fetchVecHubData();
    }
  }, [activeTab, isAuthenticated]);

  const shareToVecHub = async () => {
    if (!config.collegeName?.trim()) return showStatus("กรุณาระบุชื่อวิทยาลัย (เพื่อแยกข้อมูล)");
    if (!config.major?.trim() && !config.fieldOfStudy?.trim()) return showStatus("กรุณาระบุสาขาวิชา หรือ แผนกวิชา");
    if (!config.companyName?.trim()) return showStatus("กรุณาระบุชื่อสถานประกอบการ");
    if (!config.province?.trim()) return showStatus("กรุณาระบุจังหวัด");

    const hasValidTask = workplaceMainTasks.length > 0 && workplaceMainTasks.some(t => t.name && t.name.trim() !== '');
    if (!hasValidTask) return showStatus("กรุณาระบุ 'ชื่องานหลัก' อย่างน้อย 1 งานก่อนแชร์");

    showStatus("กำลังแชร์ข้อมูลทั้งหมดเข้าคลังอาชีวศึกษา...");
    try {
      const safeConfig = { ...config, userApiKey: '', openaiApiKey: '', claudeApiKey: '', deepseekApiKey: '' };
      ...
      await fetch(VEC_HUB_URL, {
        method: 'POST',
        body: JSON.stringify(payload),
        headers: { 'Content-Type': 'text/plain;charset=utf-8' }
      });

      showStatus("แชร์ข้อมูลแผนฝึกเต็มรูปแบบสำเร็จ!");
      setActiveTab('vechub');
    } catch (err) {
      showStatus("เกิดข้อผิดพลาดในการเชื่อมต่อ กรุณาลองอีกครั้ง");
    }
  ...
  // =====================================================
  // COURSE LIBRARY — คลังงานรายวิชา
  // =====================================================

  const normalizeSharedSubject = (subject) => ({
    id: subject.id || '',
    code: subject.code || '',
    name: subject.name || '',
    ...
    mainTasks: Array.isArray(subject.mainTasks)
      ? subject.mainTasks.map(mainTask => ({
        id: mainTask.id || '',
        name: mainTask.name || '',
        subTasks: Array.isArray(mainTask.subTasks)
  ...
  const fetchCourseLibrary = async () => {
    ...
    setIsLoadingCourseLibrary(true);

    try {
      const response = await fetch(COURSE_LIBRARY_URL, {
        method: 'POST',
        headers: { 'Content-Type': 'text/plain;charset=utf-8' },
        body: JSON.stringify({
      ...
      const result = await response.json();
      if (!result.success) {
        throw new Error(result.message || 'โหลดคลังงานรายวิชาไม่สำเร็จ');
      }
      const items = Array.isArray(result) ? result : result.items || [];

      // กรองซ้ำใน React เพื่อป้องกันการแสดงผลผิดพลาด
      // Apps Script ต้องตรวจสิทธิ์อีกชั้นหนึ่ง
      const admin =
        isDeveloper ||
      ...
      const visibleItems = admin
        ? items
        : items.filter(item =>
          String(item.college || '').trim().toLowerCase() ===
          String(currentUserCollege || '').trim().toLowerCase()
        );

      setCourseLibraryData(visibleItems);
    } catch (error) {
      console.error('Fetch course library error:', error);
      showStatus(error.message || 'โหลดคลังงานรายวิชาไม่สำเร็จ');
    } finally {
      setIsLoadingCourseLibrary(false);
    }
  };

  useEffect(() => {
    if (activeTab === 'courseLibrary' && isAuthenticated) {
      fetchCourseLibrary();
    }
  }, [activeTab, isAuthenticated, currentUserEmail]);

  const shareAnalyzedCourse = async (subjectIndex) => {
    const subject = subjects[subjectIndex];

    if (!subject?.isAnalyzed) {
      return showStatus('กรุณาวิเคราะห์รายวิชาก่อนแชร์');
    }

    if (!subject.code?.trim()) {
      return showStatus('กรุณาระบุรหัสวิชา');
    }

    if (!subject.name?.trim()) {
      return showStatus('กรุณาระบุชื่อรายวิชา');
    }

    if (!currentUserCollege?.trim()) {
      return showStatus('บัญชีผู้ใช้ไม่มีข้อมูลวิทยาลัย กรุณาติดต่อผู้ดูแลระบบ');
    }

    if (!currentUserDepartment?.trim()) {
      return showStatus('บัญชีผู้ใช้ไม่มีข้อมูลแผนกวิชา กรุณาติดต่อผู้ดูแลระบบ');
    }

    if (!subject.mainTasks?.some(task => task.name?.trim())) {
      return showStatus('รายวิชานี้ยังไม่มีข้อมูลงานหลัก');
    }
    ...
    try {
      const payload = {
        ...
        // ใช้ข้อมูลจากบัญชี ไม่ใช้ค่าที่กรอกในหน้าตั้งค่า
        college: currentUserCollege,
        department: currentUserDepartment,
        creatorEmail: currentUserEmail,
        creatorName: currentUserName,

        subject: normalizeSharedSubject(subject),
      ...
      showStatus(`แชร์วิชา ${subject.code} ${subject.name} สำเร็จ`);
    } catch (error) {
      console.error('Share course error:', error);
      showStatus('แชร์รายวิชาไม่สำเร็จ');
    } finally {
      setSharingSubjectId(null);
    }
  };

  const getCourseLibraryItemKey = (item) => {
    return (
      item.id ||
      `${item.college || ''}-${item.department || ''}-${item.subject?.code || ''}-${item.subject?.name || ''}-${item.createdAt || ''}`
    );
  };

  const toggleCourseLibrarySelection = (itemKey) => {
  ...
  const getSelectedCourseLibraryItems = () => {
    return courseLibraryData.filter(item =>
      selectedCourseLibraryIds.includes(getCourseLibraryItemKey(item))
    );
  };

  const openCourseImportConfirm = (items) => {
    if (!items || items.length === 0) {
      return showStatus('กรุณาเลือกรายวิชาที่ต้องการนำเข้า');
    }

    setPendingCourseImportItems(items);
  };

  const requestCourseLibraryImport = (clickedItem = null) => {
    const selectedItems = getSelectedCourseLibraryItems();

    if (selectedItems.length >= 2) {
      return openCourseImportConfirm(selectedItems);
    }
    ...
    if (clickedItem) {
      return openCourseImportConfirm([clickedItem]);
    }

    return showStatus('กรุณาเลือกรายวิชาที่ต้องการนำเข้า');
  };

  const confirmImportCourseLibraryItems = () => {
    const importedSubjects = pendingCourseImportItems
    ...
    setSubjects(prevSubjects => {
      ...
      importedSubjects.forEach(importedSubject => {
        const emptyIndex = nextSubjects.findIndex(subject =>
          !subject.isAnalyzed &&
          !subject.name &&
          !subject.description &&
        ...
        nextSubjects[targetIndex] = {
          ...
          previewUrl: null,
          uploadedFile: null,
          mainTasks: Array.isArray(importedSubject.mainTasks)
            ? importedSubject.mainTasks.map(mainTask => ({
              ...mainTask,
              id: String(mainTask.id || '').replace(oldId, newId),
              subTasks: Array.isArray(mainTask.subTasks)
                ? mainTask.subTasks.map(subTask => ({
                  ...subTask,
                  id: String(subTask.id || '').replace(oldId, newId)
                }))
                : []
            }))
            : []
    ...
    showStatus(`นำเข้ารายวิชา ${importedCount} วิชาเรียบร้อยแล้ว`);
  };

  const importSelectedSharedCourses = () => {
    requestCourseLibraryImport();
  };

  const importSharedCourse = (item) => {
    requestCourseLibraryImport(item);
  };
  ...
  const deleteSharedCourse = async (item) => {
    ...
    const isOwner =
      String(item.creatorEmail || '').trim().toLowerCase() ===
      String(currentUserEmail || '').trim().toLowerCase();

    if (!admin && !isOwner) {
      return showStatus('คุณไม่มีสิทธิ์ลบข้อมูลรายการนี้');
    }

    if (!window.confirm(`ยืนยันการลบวิชา ${item.subject?.name || ''} หรือไม่`)) {
      return;
    }

    setDeletingCourseId(item.id);
    ...
    try {
      ...
      setCourseLibraryData(previous =>
        previous.filter(course => course.id !== item.id)
      );

      showStatus('ลบข้อมูลรายวิชาสำเร็จ');
    } catch (error) {
      console.error('Delete course error:', error);
      showStatus('ไม่สามารถลบข้อมูลรายวิชาได้');
    } finally {
  ...
  const submitDeleteRequest = async () => {
    ...
    setIsDeleting(true);
    try {
      // ดึงชื่อบริษัทมาส่งในอีเมลด้วย (รองรับทั้ง key companyName ของ cloud และ company ของ VEC Hub)
      const companyNameForEmail = deleteModalItem.companyName || deleteModalItem.company || "ไม่ระบุชื่อบริษัท";
      const payload = {
        action: isDeveloper ? 'adminDelete' : 'deleteRequest',
        id: deleteModalItem.id,
        reason: deleteReason,
        companyName: companyNameForEmail
      };

      // เลือกว่าจะส่งคำขอไปที่ URL คลังไหน
      const targetUrl = deleteTargetHub === 'vechub' ? VEC_HUB_URL : GAS_WEB_APP_URL;

      await fetch(targetUrl, { method: 'POST', body: JSON.stringify(payload), headers: { 'Content-Type': 'text/plain;charset=utf-8' } });

      showStatus(isDeveloper ? "ลบข้อมูลถาวรสำเร็จ" : "ส่งคำขอลบข้อมูลแจ้งไปยังอีเมลผู้ดูแลแล้ว");
      setDeleteModalItem(null);
      setDeleteReason('');

      // โหลดข้อมูลมารีเฟรชหน้าจอใหม่
      if (deleteTargetHub === 'vechub') fetchVecHubData();
      else fetchCloudData();
  ...
  const runSubjectAnalysis = async (sub) => {
    ...
    2. วิเคราะห์ข้อมูลเพื่อสร้างงานหลักและงานย่อยเชิงปฏิบัติ
   - สร้างงานหลัก 3-5 งานต่อรายวิชา
   - งานหลักแต่ละงานมีงานย่อย 3-5 งาน
   - ชื่องานหลักยาว 4-8 คำ
   - ชื่องานย่อยยาว 4-10 คำ
   - เขียนให้สั้น กระชับ ชัดเจน และไม่ใส่คำอธิบายต่อท้าย
   - ใช้คำกริยาที่ปฏิบัติได้จริงขึ้นต้น เช่น เตรียม ตรวจสอบ ปฏิบัติ ผลิต ซ่อม บันทึก
   - ห้ามใช้คำว่า ศึกษา เรียนรู้ ทฤษฎี อธิบาย บอก ระบุ เข้าใจ หรือทราบ
   - ห้ามรวมหลายกิจกรรมที่ไม่เกี่ยวข้องไว้ในชื่องานเดียว
   - ต้องครอบคลุมการเตรียมงาน ปฏิบัติงาน ตรวจสอบ และบันทึกหรือส่งมอบงาน

3. รหัสงานต้องขึ้นต้นด้วย "${sub.id}" เสมอ
   - งานหลักใช้รหัส ${sub.id}1, ${sub.id}2, ${sub.id}3
   - งานย่อยใช้รหัส ${sub.id}1-1, ${sub.id}1-2, ${sub.id}2-1
   - เรียงรหัสต่อเนื่องและห้ามข้ามลำดับ

ตัวอย่างชื่อที่กระชับ:
- "เตรียมวัตถุดิบและอุปกรณ์"
- "ตรวจสอบคุณภาพวัตถุดิบ"
- "ปฏิบัติงานตามมาตรฐาน"
- "บันทึกผลการปฏิบัติงาน"

4. หลักการเขียนชื่องานหลักและงานย่อย
   - ต้องขึ้นต้นด้วยคำกริยาทางปฏิบัติ
   - ต้องระบุสิ่งที่กระทำให้ชัดเจน
   - ต้องมีขอบเขตงานชัดเจน ไม่สั้นเกินไป
   - ห้ามใช้คำว่า ศึกษา, เรียนรู้, ทฤษฎี, อธิบาย, บอก, ระบุ, เข้าใจ, ทราบ เป็นชื่องาน
   - ห้ามตั้งชื่อเป็นคำนาม หมวดหมู่ หรือหัวข้อกว้าง ๆ เช่น "เครื่องมือ", "ความปลอดภัย", "ระบบไฟฟ้า", "งานบริการ"
   - ให้แปลงเป็นงานปฏิบัติ เช่น "เตรียมเครื่องมือและตรวจสอบความพร้อมก่อนปฏิบัติงาน", "ตรวจสอบระบบไฟฟ้าตามคู่มือบริการ", "บันทึกผลและรายงานข้อบกพร่องของงาน"

5. งานหลักและงานย่อยต้องครอบคลุมสมรรถนะรายวิชาให้มากที่สุด
   - หากสมรรถนะมีหลายข้อ ต้องกระจายไปเป็นงานหลัก/งานย่อยให้ครบ
   - หากคำอธิบายรายวิชามีหลายกระบวนการ ต้องแยกเป็นงานปฏิบัติ ไม่รวมเป็นประโยคเดียว
   - หากพบเนื้อหาด้านความปลอดภัย เครื่องมือ วัสดุ มาตรฐาน คุณภาพ หรือการประเมินผล ต้องสร้างงานย่อยที่เกี่ยวข้องด้วย

6. ความยาวของชื่อ
   - ชื่องานหลักควรยาวประมาณ 8-18 คำ
   - ชื่องานย่อยควรยาวประมาณ 8-20 คำ
   - ห้ามตอบงานย่อยสั้นกว่า 5 คำ ยกเว้นเป็นชื่อกระบวนการเฉพาะที่สมบูรณ์แล้ว
...
ตัวอย่างที่ควรตอบ:
- "ตรวจสอบความพร้อมของเครื่องมือและอุปกรณ์ก่อนเริ่มปฏิบัติงาน"
- "ถอด ตรวจสอบ และเปลี่ยนชิ้นส่วนเครื่องยนต์ตามคู่มือบริการ"
- "ปฏิบัติงานโดยใช้เครื่องมือและอุปกรณ์ป้องกันอันตรายส่วนบุคคลตามมาตรฐาน"
- "บันทึกผลการตรวจสอบและรายงานข้อบกพร่องของงานให้ครูฝึกตรวจสอบ"`;
  ...
  const addSubjectSubTaskLocal = (subIndex, mainTaskIndex) => {
    setSubjects(prev => {
      const next = [...prev];
      const subject = next[subIndex];
      const mainTask = subject.mainTasks[mainTaskIndex];

      if (!mainTask.subTasks) mainTask.subTasks = [];

      const newId = `${mainTask.id}-${mainTask.subTasks.length + 1}`;
  ...
  const removeSubjectSubTaskLocal = (subIndex, mainTaskIndex, subTaskIndex) => {
    if (!window.confirm("ต้องการลบงานย่อยนี้ใช่หรือไม่?")) return;

    setSubjects(prev => {
      const next = [...prev];
      next[subIndex].mainTasks[mainTaskIndex].subTasks.splice(subTaskIndex, 1);
      return next;
    });
  };
  ...
  const addWorkplaceMainTask = () => {
    ...
    setWorkplaceMainTasks(prev => [{ id: Date.now() + Math.random(), name: '', isAnalyzing: false, isConfirmed: false, subTasks: [] }, ...prev]);
  };
...
1. แตกเป็น "งานย่อย" 4-6 งาน และเขียนขั้นตอนสำหรับใช้ใน DVE-04-06 (ฝอ.2)

- ทุกงานต้องมี 4 ขั้นหลัก ได้แก่ ขั้นเตรียม ขั้นปฏิบัติงาน ขั้นตรวจสอบผลงาน และขั้นเก็บเครื่องมือและอุปกรณ์
- เพิ่ม "ขั้นทำความสะอาด" เฉพาะงานที่มีอาหาร วัตถุดิบ สารเคมี ของเสีย สิ่งปนเปื้อน เครื่องจักร เครื่องมือ หรือพื้นที่ซึ่งต้องทำความสะอาดหลังปฏิบัติงานจริงเท่านั้น
- งานเอกสาร งานคำนวณ งานออกแบบ งานวางแผน งานประชุม งานนำเสนอ งานบริหาร และงานบริการที่ไม่ก่อให้เกิดสิ่งสกปรก ห้ามสร้างขั้นทำความสะอาด
- ห้ามเติมข้อความเกี่ยวกับการทำความสะอาดเพื่อให้จำนวนขั้นตอนครบ
- ขั้นเก็บเครื่องมือให้ระบุเฉพาะการตรวจนับ ตรวจสภาพ ปิดระบบ คืน หรือจัดเก็บตามลักษณะงาน ไม่ต้องระบุการทำความสะอาดหากไม่เกี่ยวข้อง
- objectiveRows จึงมีได้ 4 หรือ 5 รายการตามลักษณะงานจริง
- แต่ละขั้นตอนต้องขึ้นต้นด้วยคำกริยาและระบุสิ่งที่กระทำชัดเจน
...
3. การเขียน "จุดประสงค์เชิงพฤติกรรม" (objectives) สำหรับ K, S, A, Ap ต้องใช้ "คำกริยาที่วัดผลได้" ห้ามใช้คำว่า รู้จัก, เข้าใจ, ทราบ, รู้
  เขียน "จุดประสงค์เชิงพฤติกรรมของงานย่อย" ไม่ใช่จุดประสงค์แยกรายขั้นตอน
- งานย่อยแต่ละงานให้มี objectiveRows 4 รายการหลัก ได้แก่ ขั้นเตรียม ขั้นปฏิบัติงาน ขั้นตรวจสอบผลงาน และขั้นเก็บเครื่องมือและอุปกรณ์
- เพิ่มขั้นทำความสะอาดเป็นรายการที่ 5 เฉพาะเมื่อลักษณะงานจำเป็นต้องทำความสะอาดจริง
- ใน objectiveRows แต่ละรายการต้องมี steps เป็น array เสมอ
- ห้ามสร้างขั้นทำความสะอาดสำหรับงานเอกสาร งานคำนวณ งานออกแบบ งานวางแผน งานประชุม งานนำเสนอ หรืองานบริหาร
- objectiveRows ทั้งหมดต้องครอบคลุม K, S, A และ Ap
- ต้องมีอย่างน้อย 1 รายการที่ domain เป็น "Ap"
- ขั้นที่เหมาะสมกับ Ap คือขั้นตรวจสอบผลงานหรือขั้นเก็บเครื่องมือและอุปกรณ์
- หากงานไม่มีความซับซ้อน ให้ใช้ Ap1
- หากต้องวิเคราะห์ปัญหา เปรียบเทียบผล หรือแก้ปัญหาที่ไม่ชัดเจน ให้ใช้ Ap2
- หากต้องวางแผน ปรับปรุงวิธีการ หรือพัฒนาวิธีปฏิบัติใหม่ ให้ใช้ Ap3
- แต่ละ objectiveRows.steps ต้องมีอย่างน้อย 1 ขั้นตอนย่อย
- steps ทุกข้อเป็นประโยคบอกเล่า ขึ้นต้นด้วยคำกริยา และมีการกระทำเพียงอย่างเดียว
- จุดประสงค์ทุกข้อเป็นประโยคบอกเล่า
- ขึ้นต้นด้วยคำกริยาที่วัดผลได้
- ห้ามใช้คำว่า "รู้", "รู้จัก", "เข้าใจ", "ทราบ", "ตระหนัก", "เห็นความสำคัญ" ในจุดประสงค์เชิงพฤติกรรมทุกช่องโดยเด็ดขาด
- หากต้องการสื่อความรู้ ให้ใช้คำกริยาเช่น ระบุ, บอก, อธิบาย, จำแนก, เปรียบเทียบ, คำนวณ
- หากต้องการสื่อเจตคติ ให้ใช้คำกริยาเช่น ปฏิบัติตาม, รับผิดชอบ, ระมัดระวัง, ให้ความร่วมมือ, ตรวจสอบความเรียบร้อย
- ระดับ K/S/A/Ap ต้องสัมพันธ์กับคำกริยาเชิงพฤติกรรม (Action Verbs) ดังนี้:

  K1 ความรู้ความจำ (Remembering):
  ใช้เมื่อวัตถุประสงค์เน้นการระลึก บอกข้อมูลพื้นฐาน ข้อเท็จจริง คำจำกัดความ หรือหลักการ
  คำกริยาที่ใช้ได้ เช่น ระบุ, บอก, เรียกชื่อ, จับคู่, เล่า, ระลึก, แจกแจง, บรรยาย

  K2 ความเข้าใจ (Understanding):
  ใช้เมื่อวัตถุประสงค์เน้นการอธิบาย แปลความ สรุปความ หรือเปรียบเทียบความหมายของความรู้
  คำกริยาที่ใช้ได้ เช่น อธิบาย, สรุป, แปลความ, ตีความ, เปรียบเทียบ, จัดกลุ่ม, ขยายความ

  K3 การนำไปใช้ (Applying):
  ใช้เมื่อวัตถุประสงค์เน้นการนำความรู้ไปใช้ แก้ปัญหา ทดสอบ ปฏิบัติ พัฒนา หรือออกแบบในสถานการณ์จริง
  คำกริยาที่ใช้ได้ เช่น ประยุกต์ใช้, แก้ปัญหา, ดำเนินการ, ทดสอบ, ปฏิบัติ, พัฒนา, ออกแบบ

  S1 การเลียนแบบ (Imitation):
  ใช้เมื่อผู้เรียนทำตามตัวอย่างหรือขั้นตอนของครูฝึกในระยะเริ่มต้น
  คำกริยาที่ใช้ได้ เช่น ทำตาม, เลียนแบบ, วาดตาม, เคลื่อนไหวตาม, ประกอบตาม

  S2 การลงมือทำด้วยความถูกต้อง (Manipulation & Precision):
  ใช้เมื่อผู้เรียนปฏิบัติงานได้ด้วยตนเองตามคำสั่ง คู่มือ หรือมาตรฐาน โดยถูกต้องและผิดพลาดน้อย
  คำกริยาที่ใช้ได้ เช่น ปฏิบัติ, แสดง, สาธิต, จัดทำ, ควบคุม, วัด, ปรับปรุง

  S3 ความชำนาญและสร้างสรรค์ (Articulation & Naturalization):
  ใช้เมื่อผู้เรียนทำงานได้คล่อง ดัดแปลงวิธีการ แก้ปัญหา หรือสร้างสรรค์งานใหม่ได้
  คำกริยาที่ใช้ได้ เช่น ออกแบบ, สร้างสรรค์, ดัดแปลง, พัฒนา, ผสมผสาน, แก้ไขปัญหา, นำเสนอ

  A1 การยอมรับ (Receiving/Attending):
  ใช้เมื่อวัตถุประสงค์เน้นการรับรู้ ยอมรับ รับฟัง หรือให้ความสำคัญต่อกฎ ระเบียบ คุณค่า หรือความปลอดภัย
  คำกริยาที่ใช้ได้ เช่น ยอมรับ, รับฟัง, ให้ความสำคัญ, สังเกตเห็น, สนใจ

  A2 การปฏิบัติตาม (Responding):
  ใช้เมื่อวัตถุประสงค์เน้นการมีส่วนร่วม ปฏิบัติตามกฎระเบียบ ให้ความร่วมมือ หรือรายงานอย่างเหมาะสม
  คำกริยาที่ใช้ได้ เช่น ปฏิบัติตาม, ให้ความร่วมมือ, ตอบสนอง, ช่วยเหลือ, ทำตาม, รายงาน

  A3 การปฏิบัติจนเป็นนิสัย (Valuing/Characterization):
  ใช้เมื่อวัตถุประสงค์เน้นการยึดถือปฏิบัติอย่างสม่ำเสมอ เป็นแบบอย่าง หรือแสดงค่านิยมในการทำงาน
  คำกริยาที่ใช้ได้ เช่น ยึดมั่น, ประพฤติเป็นนิสัย, แสดงออกอย่างสม่ำเสมอ, สนับสนุน, ปกป้อง, เป็นแบบอย่าง

  Ap1 การประยุกต์ใช้เพื่อแก้ปัญหาในหน้าที่ (Routine Application):
  ใช้เมื่อผู้เรียนนำความรู้และทักษะไปใช้แก้ปัญหาในงานปกติที่รับผิดชอบ
  คำกริยาที่ใช้ได้ เช่น ประยุกต์ใช้, แก้ไขปัญหา, ดำเนินการ, ปรับใช้, เลือกใช้, ปฏิบัติงาน

  Ap2 การประยุกต์ใช้ในงานที่ซับซ้อนหรือไม่ชัดเจน (Complex Problem Solving):
  ใช้เมื่อผู้เรียนวิเคราะห์ ใช้ดุลยพินิจ หรือจัดการปัญหาที่มีตัวแปรมากและไม่มีคำตอบตายตัว
  คำกริยาที่ใช้ได้ เช่น วิเคราะห์ปัญหา, วินิจฉัย, ปรับเปลี่ยน, ประเมินสถานการณ์, คลี่คลาย, ระบุแนวทาง

  Ap3 การวางแผนกลยุทธ์และพัฒนาในภาวะเปลี่ยนแปลง (Strategic Adaptation):
  ใช้เมื่อผู้เรียนวางแผนเชิงรุก ออกแบบแนวทาง พัฒนาวิธีการใหม่ หรือปรับปรุงระบบ
  คำกริยาที่ใช้ได้ เช่น วางแผนกลยุทธ์, ออกแบบแนวทาง, พัฒนาวิธีการ, สร้างนวัตกรรม, ปรับปรุงระบบ, บูรณาการ

- ห้ามกำหนดระดับสูงเกินคำกริยา เช่น ถ้าวัตถุประสงค์ใช้เพียง "ระบุ" หรือ "บอก" ให้เป็น K1 เท่านั้น ไม่ใช่ K3
- หากข้อความเป็นเพียงการทำตามตัวอย่าง ให้ใช้ S1 ไม่ใช่ S2 หรือ S3
- หากข้อความเป็นเพียงการปฏิบัติตามระเบียบ ให้ใช้ A2 ไม่ใช่ A3
- หากข้อความเป็นเพียงการแก้ปัญหางานประจำ ให้ใช้ Ap1 ไม่ใช่ Ap2 หรือ Ap3
- ห้ามใช้คำว่า "เข้าใจ", "ทราบ", "รู้", "รู้จัก" ในจุดประสงค์เชิงพฤติกรรมทุกช่อง
4. **กฎเหล็กการตั้งชื่องาน (บังคับใช้เคร่งครัด)**: 
- ชื่องานย่อย (\`workplaceName\`) และ ขั้นตอนการปฏิบัติงาน (\`step_text\`) **ต้องเป็นชื่อการปฏิบัติงานและขึ้นต้นด้วยคำกริยา (Action Verb) เสมอ** (เช่น เตรียม, ผัด, ปรุง, จัดตกแต่ง, ประกอบ, ตรวจสอบ, บำรุงรักษา)
- **ห้ามตั้งชื่อเป็นสถานที่ พื้นที่ หมวดหมู่ หรือคำนามเฉยๆ เด็ดขาด** (เช่น ห้ามตอบ "ห้องครัว", "พื้นที่เตรียมอาหาร", "อุปกรณ์", "ความปลอดภัย")
- **หากงานหลักเป็นคำนาม เช่น อาหาร หรือ สิ่งของ (เช่น "ผัดไทย", "เครื่องยนต์") ให้แตกงานย่อยเป็นกระบวนการทำ** (เช่น 1. เตรียมวัตถุดิบ 2. ปรุงผัดไทย 3. จัดเสิร์ฟ)
- **ห้าม** มีคำว่า "การ", "ความ", "ศึกษา", "เรียนรู้", "ทฤษฎี" อยู่ในชื่องานย่อยและขั้นตอนการปฏิบัติงานโดยเด็ดขาด ให้ใช้คำกริยาทางปฏิบัติการทั้งหมด (เช่น ตรวจสอบ, บำรุงรักษา, ปฏิบัติงาน)
5. ขั้นตอนแรกต้องเป็นการเตรียมงานตามลักษณะงาน และขั้นตอนสุดท้ายต้องเป็นการตรวจสภาพ คืน หรือจัดเก็บสิ่งที่ใช้งาน ส่วนการทำความสะอาดให้สร้างเฉพาะเมื่อจำเป็นต่อความปลอดภัย สุขลักษณะ คุณภาพ หรือการคืนสภาพพื้นที่จริงเท่านั้น
6. ระบุ "สื่อ/อุปกรณ์" (equipment) ที่ต้องใช้ในแต่ละขั้นตอน
7. **กฎเหล็กการตอบกลับ (สำคัญที่สุด)**: 
- ต้องตอบเป็น **ภาษาไทยเท่านั้น** (ยกเว้นรหัสอ้างอิง)
- **ห้ามอธิบายกระบวนการคิด ห้ามมีคำนำหน้า เช่น Mapping:, Note:, หรือ Explanation:**
- ให้ระบุเฉพาะข้อมูลสั้นๆ กระชับ ตรงประเด็นลงใน JSON เท่านั้น ห้ามเขียนเรียงความภาษาอังกฤษมาเด็ดขาด`;
      ...
      const newSubTasks = safeSubTasks.map((st, i) => {
        ...
        const rawObjectiveRows = Array.isArray(st.objectiveRows)
          ? st.objectiveRows
          : [];

        const hasCleaningStage = rawObjectiveRows.some(row =>
          String(row?.stage || '').includes('ทำความสะอาด')
        );
        const fo2Stages = [
          'ขั้นเตรียม',
          'ขั้นปฏิบัติงาน',
          'ขั้นตรวจสอบผลงาน',
          'ขั้นเก็บเครื่องมือและอุปกรณ์',
          ...(hasCleaningStage ? ['ขั้นทำความสะอาด'] : [])
        ];
        let normalizedObjectiveRows = fo2Stages.map((stage, rowIdx) => {
          const row =
            rawObjectiveRows.find(r => String(r?.stage || "").includes(stage)) ||
            rawObjectiveRows[rowIdx] ||
            {};

          return {
            stage,
            steps: Array.isArray(row.steps)
              ? row.steps.map(step => String(step || "").trim()).filter(Boolean)
              : [],
            objective: row.objective || "",
            domain: row.domain || "",
            level: row.level || 1,
            teachingMethod: row.teachingMethod || "สาธิต/ฝึกปฏิบัติ",
            equipment: row.equipment || "ของจริง / คู่มือ",
            evaluation: row.evaluation || "สังเกตพฤติกรรม"
          };
        });
        if (!normalizedObjectiveRows.some(row => row.domain === "Ap")) {
          normalizedObjectiveRows = normalizedObjectiveRows.map((row, rowIdx) => {
            if (rowIdx !== 2) return row;

            return {
              ...row,
              domain: "Ap",
              level: 1,
              objective: row.objective || "ประยุกต์ใช้วิธีตรวจสอบผลงานเพื่อแก้ไขข้อบกพร่องเบื้องต้นได้ตามมาตรฐานการปฏิบัติงาน"
            };
          });
        }
        return {
      ...
      // แทนที่โค้ดเดิม: setWorkplaceMainTasks(prev => prev.map(t => t.id === taskId ? { ...t, subTasks: newSubTasks, isAnalyzing: false } : t));

      setWorkplaceMainTasks(prev => {
        // 1. ดึงงานที่กำลังวิเคราะห์ออกมาเพื่ออัปเดตข้อมูล
        const taskToUpdate = prev.find(t => t.id === taskId);
        if (!taskToUpdate) return prev;

        const finishedTask = { ...taskToUpdate, subTasks: newSubTasks, isAnalyzing: false };

        // 2. คัดแยกงานอื่นๆ ที่เหลือ (ลบงานที่เพิ่งทำเสร็จออกชั่วคราว)
        const otherTasks = prev.filter(t => t.id !== taskId);

        // 3. นำงานที่วิเคราะห์เสร็จสมบูรณ์ไปต่อท้ายสุดของรายการ
        return [...otherTasks, finishedTask];
      });

      showStatus("วิเคราะห์งานย่อยในสถานประกอบการสำเร็จ");
    } catch (e) {
      showStatus("ขัดข้อง: " + e.message);
...
หน้าที่ของคุณคือเขียน "ขั้นตอนการปฏิบัติงาน" และ "จุดประสงค์เชิงพฤติกรรมของงานย่อย" สำหรับใช้ในตาราง ฝอ.2

1. เขียนขั้นตอนหลัก 4 ขั้นตามลำดับ:
   1) ขั้นเตรียม
   2) ขั้นปฏิบัติงาน
   3) ขั้นตรวจสอบผลงาน
   4) ขั้นเก็บเครื่องมือและอุปกรณ์

2. เพิ่มขั้นที่ 5 "ขั้นทำความสะอาด" เฉพาะเมื่อเนื้องานเกี่ยวข้องกับอาหาร วัตถุดิบ สารเคมี ของเสีย สิ่งปนเปื้อน เครื่องจักร เครื่องมือ หรือพื้นที่ที่ต้องทำความสะอาดจริง

- งานเอกสาร งานคำนวณ งานออกแบบ งานวางแผน งานประชุม งานนำเสนอ งานบริหาร และงานบริการที่ไม่ก่อให้เกิดสิ่งสกปรก ห้ามสร้างขั้นทำความสะอาด
- ห้ามนำการทำความสะอาดไปใส่ในขั้นเก็บเครื่องมือ หากเนื้องานไม่จำเป็นต้องทำความสะอาด
- objectiveRows ต้องมี 4 รายการ หรือ 5 รายการเมื่อจำเป็นต้องทำความสะอาดจริง

3. รูปแบบการเขียน steps
- แต่ละ steps ต้องเป็นประโยคบอกเล่า
- แต่ละ steps ต้องขึ้นต้นด้วยคำกริยา
- แต่ละ steps ต้องมีการกระทำเพียงอย่างเดียว
- ต้องระบุสิ่งที่กระทำ เครื่องมือ วัสดุ จุดตรวจ หรือมาตรฐานที่เกี่ยวข้อง
- ห้ามเขียนสั้นเกินไป เช่น "ตรวจสอบเครื่องมือ", "ทำความสะอาดพื้นที่", "จัดเก็บอุปกรณ์"
- ให้เขียนเป็น "ตรวจสอบสภาพเครื่องมือหลักและอุปกรณ์ประกอบก่อนใช้งานตามรายการตรวจสอบ"
- ห้ามนำขั้นตอนทั้งหมดไปรวมไว้ใน detailed_steps เพียงอย่างเดียว

${pool.length > 0 ? `3. **สำคัญมาก (การจับคู่รหัส Mapping ด้วยลักษณะงาน)**: นำ "ภาพรวมงานย่อย" และ "ขั้นตอนการปฏิบัติงาน" มาพิจารณาเปรียบเทียบกับพูลสมรรถนะวิชา: ${JSON.stringify(pool.map(t => ({ id: t.id, name: t.name })))}
- ให้จับคู่โดยพิจารณาจาก "ลักษณะการปฏิบัติงาน" และ "เป้าหมาย/สิ่งที่ถูกกระทำ" ประกอบกันเสมอ
- หากภาพรวมงานย่อยสอดคล้องกับพูล ให้ระบุรหัสใน subjectTaskId ของงานย่อย
- หากขั้นตอนย่อยใดมีลักษณะคล้ายคลึงกับงานใดในพูลวิชา ให้ระบุรหัสนั้นลงใน subjectTaskId ของ detailed_steps
- ต้องตอบเป็นรหัสงานย่อยตามข้อมูลในพูลวิชาเท่านั้น เช่น A1-1 หรือ B2-2
- ห้ามตอบรหัสงานหลักแบบกว้าง ๆ เช่น A1 หรือ B2
- ห้ามมีข้อความอื่นปนใน subjectTaskId` : `3. ไม่มีข้อมูลพูลสมรรถนะ ให้เว้น subjectTaskId ได้`}

4. กลุ่มคำที่ถือว่าสอดคล้องกันสำหรับการจับคู่
- แก้ปัญหา/ซ่อมบำรุง: แก้ไขข้อขัดข้อง, ตรวจซ่อม, ซ่อมบำรุง, ซ่อมแซม, ซ่อม, แก้ปัญหา, แก้ไข, ปรับปรุง, ปรับแต่ง, ปรับตั้ง, เปลี่ยนอุปกรณ์, เปลี่ยนอะไหล่
- จัดการ/ตรวจสอบ: ตรวจสอบ, สอบทาน, เช็ค, ตรวจเช็ค, ทดสอบ, วิเคราะห์, จัดการ, บริหาร, คัดแยก, บรรจุ, ควบคุมคุณภาพ
- การใช้และดูแลเครื่องมือ: เลือกใช้เครื่องมือ, เลือกเครื่องมือ, ใช้เครื่องมือ, บำรุงรักษา, ทำความสะอาด, ดูแล, เช็ด
- วางแผน/สร้างสรรค์: ออกแบบ, วางแผน, วางโครงสร้าง, คิดค้น, ประดิษฐ์, กำหนด
...
- เขียน "จุดประสงค์เชิงพฤติกรรมของงานย่อย" ไม่ใช่จุดประสงค์แยกรายขั้นตอน
- งานย่อย 1 งาน ให้มี objectiveRows 4 รายการหลัก และเพิ่มเป็น 5 รายการเฉพาะเมื่องานจำเป็นต้องมีขั้นทำความสะอาด
- จุดประสงค์ทุกข้อเป็นประโยคบอกเล่า
- ขึ้นต้นด้วยคำกริยาที่วัดผลได้
- มี 3 ส่วน ได้แก่ พฤติกรรมหลัก หรือพฤติกรรมที่คาดหวัง + เงื่อนไข + เกณฑ์หรือมาตรฐาน
- จุดประสงค์ 1 ข้อ ใช้สำหรับการเรียนรู้ 1 อย่าง
- ห้ามใช้คำว่า "รู้", "รู้จัก", "เข้าใจ", "ทราบ", "ตระหนัก", "เห็นความสำคัญ" โดยเด็ดขาด
- หากต้องการสื่อความรู้ ให้ใช้คำกริยา เช่น ระบุ, บอก, อธิบาย, จำแนก, เปรียบเทียบ, คำนวณ
- หากต้องการสื่อทักษะ ให้ใช้คำกริยา เช่น ปฏิบัติ, แสดง, สาธิต, จัดทำ, ควบคุม, วัด, ปรับปรุง
- หากต้องการสื่อเจตคติ ให้ใช้คำกริยา เช่น ปฏิบัติตาม, รับผิดชอบ, ระมัดระวัง, ให้ความร่วมมือ, ตรวจสอบความเรียบร้อย
- หากต้องการสื่อการประยุกต์ใช้ ให้ใช้คำกริยา เช่น ประยุกต์ใช้, แก้ไขปัญหา, ดำเนินการ, ปรับใช้, เลือกใช้, ปฏิบัติงาน

6. ระดับ K/S/A/Ap ต้องสัมพันธ์กับคำกริยาเชิงพฤติกรรม

K1 การฟื้นคืนความรู้:
ใช้เมื่อเน้นการระลึก บอกข้อมูลพื้นฐาน ข้อเท็จจริง คำจำกัดความ หรือหลักการ
คำกริยา เช่น ระบุ, บอก, เรียกชื่อ, จับคู่, เล่า, ระลึก, แจกแจง, บรรยาย

K2 การประยุกต์ความรู้ระดับอธิบาย:
ใช้เมื่อเน้นการอธิบาย แปลความ สรุปความ หรือเปรียบเทียบความหมายของความรู้
คำกริยา เช่น อธิบาย, สรุป, แปลความ, ตีความ, เปรียบเทียบ, จัดกลุ่ม, ขยายความ

K3 การส่งถ่ายความรู้:
ใช้เมื่อเน้นการนำความรู้ไปใช้ วิเคราะห์ สังเคราะห์ ประเมินค่า หรือแก้ปัญหาใหม่
คำกริยา เช่น ประยุกต์ใช้, แก้ปัญหา, ดำเนินการ, ทดสอบ, ปฏิบัติ, พัฒนา, ออกแบบ, วิเคราะห์, ประเมิน

S1 ขั้นการเลียนแบบ:
ใช้เมื่อผู้เรียนทำตามตัวอย่างหรือขั้นตอนของครูฝึกในระยะเริ่มต้น
คำกริยา เช่น ทำตาม, เลียนแบบ, วาดตาม, เคลื่อนไหวตาม, ประกอบตาม

S2 ขั้นทำด้วยความถูกต้อง:
ใช้เมื่อผู้เรียนปฏิบัติงานได้ด้วยตนเองตามคำสั่ง คู่มือ หรือมาตรฐาน
คำกริยา เช่น ปฏิบัติ, แสดง, สาธิต, จัดทำ, ควบคุม, วัด, ปรับปรุง

S3 ขั้นชำนาญ:
ใช้เมื่อผู้เรียนทำงานได้คล่อง ดัดแปลงวิธีการ แก้ปัญหา หรือสร้างสรรค์งานใหม่ได้
คำกริยา เช่น ออกแบบ, สร้างสรรค์, ดัดแปลง, พัฒนา, ผสมผสาน, แก้ไขปัญหา, นำเสนอ

A1 การยอมรับ:
ใช้เมื่อเน้นการรับรู้ ยอมรับ รับฟัง หรือให้ความสำคัญต่อกฎ ระเบียบ คุณค่า หรือความปลอดภัย
คำกริยา เช่น ยอมรับ, รับฟัง, ให้ความสำคัญ, สังเกตเห็น, สนใจ

A2 การตอบสนอง:
ใช้เมื่อเน้นการมีส่วนร่วม ปฏิบัติตามกฎระเบียบ ให้ความร่วมมือ หรือรายงานอย่างเหมาะสม
คำกริยา เช่น ปฏิบัติตาม, ให้ความร่วมมือ, ตอบสนอง, ช่วยเหลือ, ทำตาม, รายงาน

A3 ลักษณะนิสัย:
ใช้เมื่อเน้นการยึดถือปฏิบัติอย่างสม่ำเสมอ เป็นแบบอย่าง หรือแสดงค่านิยมในการทำงาน
คำกริยา เช่น ยึดมั่น, ประพฤติเป็นนิสัย, แสดงออกอย่างสม่ำเสมอ, สนับสนุน, ปกป้อง, เป็นแบบอย่าง

Ap1 แก้ปัญหาในการปฏิบัติงานที่รับผิดชอบ:
ใช้เมื่อผู้เรียนนำความรู้และทักษะไปใช้แก้ปัญหาในงานปกติที่รับผิดชอบ
คำกริยา เช่น ประยุกต์ใช้, แก้ไขปัญหา, ดำเนินการ, ปรับใช้, เลือกใช้, ปฏิบัติงาน

Ap2 ประยุกต์ความรู้และทักษะในการแก้ปัญหางานที่ซับซ้อน:
ใช้เมื่อผู้เรียนวิเคราะห์ ใช้ดุลยพินิจ หรือจัดการปัญหาที่มีตัวแปรมากและไม่มีคำตอบตายตัว
คำกริยา เช่น วิเคราะห์ปัญหา, วินิจฉัย, ปรับเปลี่ยน, ประเมินสถานการณ์, คลี่คลาย, ระบุแนวทาง

Ap3 วางแผนการแก้ปัญหาหรือพัฒนาวิธีการปฏิบัติงาน:
ใช้เมื่อผู้เรียนวางแผนเชิงรุก ออกแบบแนวทาง พัฒนาวิธีการใหม่ หรือปรับปรุงระบบ
คำกริยา เช่น วางแผนกลยุทธ์, ออกแบบแนวทาง, พัฒนาวิธีการ, สร้างนวัตกรรม, ปรับปรุงระบบ, บูรณาการ

7. กฎการเลือกระดับ
- ห้ามกำหนดระดับสูงเกินคำกริยา เช่น ถ้าใช้ "ระบุ" หรือ "บอก" ให้เป็น K1 เท่านั้น
- หากข้อความเป็นเพียงการทำตามตัวอย่าง ให้ใช้ S1
- หากผู้เรียนปฏิบัติตามคู่มือหรือมาตรฐานได้ถูกต้อง ให้ใช้ S2
- หากข้อความเป็นเพียงการปฏิบัติตามระเบียบ ให้ใช้ A2
- หากข้อความเป็นเพียงการแก้ปัญหางานประจำ ให้ใช้ Ap1

8. กฎการตั้งชื่อและเขียนขั้นตอน
- ชื่องานย่อยและขั้นตอนต้องขึ้นต้นด้วยคำกริยา
- ห้ามตั้งชื่อเป็นสถานที่ พื้นที่ หมวดหมู่ หรือคำนามเฉย ๆ
- ห้ามใช้คำว่า "การ", "ความ", "ศึกษา", "เรียนรู้", "ทฤษฎี" ในชื่องานย่อยและขั้นตอน
- หากงานหลักเป็นคำนาม เช่น อาหารหรือสิ่งของ ให้แตกเป็นกระบวนการทำ
- ขั้นแรกต้องเป็นการเตรียมงาน เตรียมเครื่องมือ เตรียมวัสดุ หรือเตรียมวัตถุดิบ
- ขั้นสุดท้ายให้ตรวจสภาพ คืน หรือจัดเก็บสิ่งที่ใช้งาน และเพิ่มการทำความสะอาดเฉพาะเมื่อลักษณะงานจำเป็นจริง

9. การตอบกลับ
- ต้องตอบเป็นภาษาไทยเท่านั้น ยกเว้นรหัสอ้างอิง
- ห้ามอธิบายกระบวนการคิด
- ห้ามมีคำนำหน้า เช่น Mapping:, Note:, Explanation:
- ให้ตอบเฉพาะ JSON ตาม schema เท่านั้น`;
      ...
      const result = await callAI({
        contents: [{ parts: [{ text: `วิเคราะห์งานย่อยและจัดทำตาราง ฝอ.2 สำหรับงานย่อย: ${subTask.workplaceName}` }] }],
        systemInstruction: { parts: [{ text: systemPrompt }] },
        generationConfig
      });

      const rawObjectiveRows = Array.isArray(result.objectiveRows) ? result.objectiveRows : [];
      const hasCleaningStage = rawObjectiveRows.some(row =>
        String(row?.stage || '').includes('ทำความสะอาด')
      );
      ...
      setWorkplaceMainTasks(prev => {
        const next = [...prev];
        const safeSubTaskId = extractValidTaskIds(result.subjectTaskId);

        if (safeSubTaskId) {
          next[mIdx].subTasks[sIdx].id = safeSubTaskId;
          next[mIdx].subTasks[sIdx].subjectTaskId = safeSubTaskId;

          const poolItem = pool.find(p => p.id === safeSubTaskId.split(',')[0].trim());
          if (poolItem) {
            next[mIdx].subTasks[sIdx].name = cleanTaskName(poolItem.name);
          }
        }
        next[mIdx].subTasks[sIdx].fo2Version = 2;
        next[mIdx].subTasks[sIdx].objectiveRows = normalizedObjectiveRows;
  ...
  // --- เพิ่มโค้ด 2 ตัวแปรนี้ต่อท้าย ---
  const totalAssignedHours = useMemo(() => {
    return workplaceMainTasks.reduce((total, main) => {
      return total + (main.subTasks || []).reduce((sum, sub) => sum + (Number(sub.hours) || 0), 0);
    }, 0);
  }, [workplaceMainTasks]);

  const remainingTrainingHours = totalTrainingHours - totalAssignedHours;
  // ------------------------------
  ...
  const analyzedSubjectLearningOutcomes = useMemo(() => {
    return subjects
  ...
  const exportToWord = (elementId, filename, formCodeOverride = '') => {
    ...
    // เปลี่ยนข้อความที่มีการขึ้นบรรทัดใหม่ให้เป็น Paragraph จริง
    // เมื่อเปิดใน Word แต่ละบรรทัดจะเป็น ^p
    exportContent.querySelectorAll('.whitespace-pre-line').forEach(element => {
      const lines = String(element.textContent || '')
        .replace(/\r\n?/g, '\n')
        .split(/\n+/)
        .map(line => line.trim())
        .filter(Boolean);
      ...
      const paragraphs = lines.map(line => {
        ...
        paragraph.className = 'word-paragraph';
    ...
    // ดึงรหัสแบบฟอร์มจากชื่อไฟล์ เช่น DVE-04-02
    const formCodeMatch = filename.match(/DVE[-_\s]?04[-_\s]?\d{2}/i);

    const formCode = formCodeOverride || (
      formCodeMatch
        ? formCodeMatch[0]
          .replace(/[_\s]+/g, '-')
          .toUpperCase()
    ...
    const wordHeader = formCode
      ? `
      <div id="dveWordHeader" style="mso-element:header;">
        <p class="dve-word-header-text">${formCode}</p>
      </div>
    `
      : '';
    ...
    <head>
      ...
      <style>
        ...
        /* ทุกบรรทัดเป็นย่อหน้า ^p และไม่มีช่องว่างเกิน */
        p,
        .word-paragraph,
        .numbered-paragraph {
          display: block;
        ...
        /* ซ่อนรหัส DVE ที่อยู่ในเนื้อหา ป้องกันซ้ำกับหัวกระดาษ */
        .has-dve-word-header .dve-inline-code {
  display: none;
}
     ...
     <body class="${formCode ? 'has-dve-word-header' : ''}">
    ${wordHeader}
...
`;
  ...
  `;
    ...
    const html = header + exportContent.innerHTML + footer;
  ...
  const formatNumberedText = (text, forceNumbered = false) => {
    ...
    const normalizedText = String(text)
      ...
      // กรณี 1. ข้อความ 2. ข้อความ ติดกัน
      // ให้ขึ้นย่อหน้าใหม่ก่อนเลขข้อถัดไป
    ...
    return (
      <div className="numbered-text">
        {items.map((item, index) => {
          const hasNumber = /^\d{1,2}[.)]\s*/.test(item);

          const cleanItem = item
            .replace(/^\d{1,2}[.)]\s*/, '')
            .trim();

          const displayedText = forceNumbered
            ? `${index + 1}. ${cleanItem}`
            : hasNumber
              ? item
              : cleanItem;
          ...
          return (
            <p
              key={index}
              className="numbered-paragraph text-left"
              style={{
                margin: 0,
                padding: 0,
                lineHeight: 1.2
  ...
  const navItems = [
    ...
    { id: 'workplace', baseLabel: 'วิเคราะห์งานบริษัท', i: Building2 },
    { id: 'reports', baseLabel: 'รายงาน', i: FileText },
    { id: 'evaluation', baseLabel: 'แบบประเมินฝึกอาชีพ', i: ClipboardCheck },
    { id: 'share', baseLabel: 'แชร์แผนฝึก', i: UploadCloud },
    { id: 'cloud', baseLabel: 'คลังงานสถานประกอบการ', i: Cloud },
    { id: 'courseLibrary', baseLabel: 'คลังงานรายวิชา', i: BookOpen },
    { id: 'vechub', baseLabel: 'คลังแผนฝึกอาชีวศึกษา', i: Library },// <-- เพิ่มบรรทัดนี้
    { id: 'feedback', baseLabel: 'ประเมินระบบการใช้งาน', i: Star },
    ...(isAdminUser ? [{ id: 'admin', baseLabel: 'จัดการผู้ใช้', i: Users }] : [])
  ].map((item, index) => ({
    ...item,
    l: item.href || item.id === 'admin' ? item.baseLabel : `${['๑', '๒', '๓', '๔', '๕', '๖', '๗', '๘', '๙', '๑๐', '๑๑', '๑๒'][index] || index + 1}. ${item.baseLabel}`
  }));
  // ==========================================
  // VIEW RENDERS
  // ==========================================
        ...
        <div className="w-full max-w-md bg-white p-8 md:p-10 rounded-3xl border border-slate-200 shadow-2xl animate-in zoom-in-95 duration-500 z-10 relative">
          ...
          {loginMode === 'register' && (
            <form onSubmit={submitRegister} className="space-y-3 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
              ...
              {/* เลือกจังหวัดก่อน */}
              <select
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 font-bold text-xs text-slate-600"
                value={authData.province}
              ...
              {/* ครูฝึกกรอกสถานประกอบการ */}
              {authData.role === 'ครูฝึกในสถานประกอบการ' ? (
                <input
                  type="text"
                  placeholder="ชื่อสถานประกอบการ"
                  className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 font-bold text-xs"
                  value={authData.companyName}
                  onChange={e =>
                    handleAuthChange('companyName', e.target.value)
                  }
                  required
                />
              ) : (
                <>
                  {/* ผู้ใช้สายวิทยาลัยเลือกวิทยาลัยตามจังหวัด */}
                  <select
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-indigo-500 font-bold text-xs text-slate-600 disabled:bg-slate-100 disabled:text-slate-400"
                    value={
                      useCustomCollege
                        ? '__custom__'
                        : authData.college
                    ...
                    onChange={e =>
                      handleRegisterCollegeChange(e.target.value)
                    }
                    disabled={!authData.province}
                    required
                  >
                    <option value="">
                      {authData.province
                    ...
                    <option value="__custom__">
                      อื่น ๆ / ไม่พบรายชื่อวิทยาลัย
                    </option>
                  </select>

                  {/* กรณีไม่พบวิทยาลัยในรายการ */}
                  {useCustomCollege && (
                    <input
                      type="text"
                      placeholder="กรอกชื่อวิทยาลัย"
                      className="w-full px-4 py-3 bg-amber-50 border border-amber-200 rounded-xl outline-none focus:ring-2 focus:ring-amber-500 font-bold text-xs"
                      value={authData.college}
                      onChange={e =>
                        handleAuthChange('college', e.target.value)
                      }
                      required
                      autoFocus
                    />
              ...
              <input
                ...
                onChange={e =>
                  handleAuthChange('department', e.target.value)
                }
                required
              />
  ...
  return (
    <div className={`min-h-screen font-sans text-slate-900 pb-20 font-serif transition-colors duration-500 ${activeTab === 'cloud' ? 'bg-slate-800' : 'bg-slate-50'}`}>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-lg w-full animate-in zoom-in-95 duration-300 border-t-8 border-amber-500">
            ...
            <div className="space-y-3">
              <button onClick={() => executeApplyDveData(pendingDveData, 'append')} className="w-full py-3 px-4 bg-blue-600 text-white rounded-2xl font-black shadow-md hover:bg-blue-700 transition-all text-sm text-left flex flex-col items-start gap-1">
                <span className="flex items-center gap-2"><Plus size={16} /> 1.จดจำงาน (เพิ่มรายวิชาในช่องว่างถัดไป)</span>
              ...
              <button onClick={() => executeApplyDveData(pendingDveData, 'merge')} className="w-full py-3 px-4 bg-indigo-600 text-white rounded-2xl font-black shadow-md hover:bg-indigo-700 transition-all text-sm text-left flex flex-col items-start gap-1">
                <span className="flex items-center gap-2"><ListChecks size={16} /> 2. นำข้อมูลของท่านกับสถานประกอบการรวมกัน</span>
              ...
              <button onClick={() => executeApplyDveData(pendingDveData, 'overwrite')} className="w-full py-3 px-4 bg-slate-800 text-white rounded-2xl font-black shadow-md hover:bg-slate-900 transition-all text-sm text-left flex flex-col items-start gap-1">
                <span className="flex items-center gap-2"><FileDown size={16} /> 3. ใช้ข้อมูลที่นำเข้าทั้งหมด (ไฟล์ใหม่)</span>
              ...
              <button onClick={() => executeApplyDveData(pendingDveData, 'keep_current')} className="w-full py-3 px-4 bg-emerald-600 text-white rounded-2xl font-black shadow-md hover:bg-emerald-700 transition-all text-sm text-left flex flex-col items-start gap-1">
                <span className="flex items-center gap-2"><Save size={16} /> 4. ใช้ข้อมูลเฉพาะของฉัน (ข้อมูลเดิม)</span>
            ...
            {['eval_workplace', 'eval_supervision', 'dve1102'].includes(showDownloadConfirm) && workplaceTasksFlat.length === 0 ? (
              ...
              <>
                ...
                <div className="flex flex-col gap-3">
                  <button
                    onClick={() => {
                      if (showDownloadConfirm === 'eval_workplace') {
                        exportToWord(
                          'dve-eval-workplace-area',
                          'แบบประเมินปฏิบัติงาน_งานย่อย'
                        );

                      } else if (showDownloadConfirm === 'eval_supervision') {
                        exportToWord(
                          'dve-supervision-area',
                          'แบบนิเทศติดตาม_รายวิชา'
                        );

                      } else if (showDownloadConfirm === 'dve1102') {
                        exportToWord(
                          'dve-11-02-area',
                          'สรุปผลการเรียนรู้รายวิชา'
                        );

                      } else if (showDownloadConfirm === 'reports') {
                        exportToWord(
                          'dve-all-area',
                          isWorkplaceTrainer
                            ? 'DVE_Reports_Workplace_Only'
                            : 'DVE_Reports_Complete'
                        );

                      } else if (showDownloadConfirm === 'dve0401') {
                        exportToWord(
                          'dve-0401-area',
                          'DVE-04-01_ข้อมูลทั่วไป',
                          'DVE-04-01'
                        );
                        ...
                        exportToWord(
                          'dve-0403-area',
                          'DVE-04-03_วิเคราะห์เทียบรายวิชา',
                          'DVE-04-03'
                        );
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* ADMIN TAB */}
        {activeTab === 'admin' && (isDeveloper || currentUserRole === 'ผู้ดูแลระบบ') && (
                      ...
                      {f.k === 'level' ? (
                        <select className="w-full mt-1 px-4 py-2.5 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none transition font-bold shadow-inner text-sm font-serif bg-slate-50"
                          ...
                          onChange={e => {
                            ...
                            let requiredWeeks = config.weeks;

                            if (selectedLevel === 'ปวส.') {
                              requiredWeeks = 15;
                            } else if (selectedLevel === 'ปวช.') {
                              requiredWeeks = 18;
                            } else if (selectedLevel === 'ปวช. และ ปวส.') {
                              requiredWeeks = 18;
                            }
              ...
              {subjects.map((sub, idx) => (
                <div key={sub.id} className={`p-6 rounded-3xl border-2 transition-all duration-500 shadow-sm ${sub.isAnalyzed ? 'bg-green-50 border-green-500 opacity-95' : 'bg-white border-slate-100 hover:border-indigo-300'}`}>
                  <div className="flex items-center gap-4 mb-6 font-serif">
                    ...
                    <div className="flex-1 font-serif space-y-2">
                      <input
                        className="w-full font-black text-xs bg-transparent outline-none border-b-2 border-slate-200 focus:border-indigo-500"
                      ...
                      <input
                        className={`w-full font-black text-sm bg-transparent outline-none border-b-2 transition-colors font-serif ${sub.isAnalyzed
                          ? 'border-green-300 text-green-900'
                          : 'border-slate-50 focus:border-indigo-500'
                          }`}
                    ...
                    {sub.isAnalyzed && (
                      <button
                        type="button"
                        onClick={() => shareAnalyzedCourse(idx)}
                        disabled={sharingSubjectId === sub.id}
                        className="w-full mt-3 py-3 rounded-2xl text-sm font-black bg-indigo-600 text-white hover:bg-indigo-700 shadow-lg transition-all flex items-center justify-center gap-2 disabled:bg-slate-300 disabled:cursor-not-allowed"
                      >
                        {sharingSubjectId === sub.id ? (
                          <>
            ...
            <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm font-serif">
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-10 border-b pb-6 gap-6">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-2 font-bold uppercase tracking-widest italic">วิเคราะห์งานหลักและงานย่อย</p>

                  {/* --- เพิ่มกล่องแสดงชั่วโมงตรงนี้ --- */}
                  <div className="flex items-center gap-4 mt-4">
                    <div className={`px-4 py-2.5 rounded-2xl text-xs font-bold border shadow-sm flex items-center gap-2 font-serif ${remainingTrainingHours === 0 ? 'bg-green-50 text-green-700 border-green-200' : remainingTrainingHours > 0 ? 'bg-amber-50 text-amber-700 border-amber-200' : 'bg-red-50 text-red-700 border-red-200'}`}>
                      <Clock size={16} className="flex-shrink-0" />
                      <span>เวลาเป้าหมาย: {totalTrainingHours} ชม.</span>
                      <span className="border-l border-current opacity-30 h-4 mx-1"></span>
                      <span>จัดสรรแล้ว: <span className="font-black text-sm">{totalAssignedHours}</span> ชม.</span>
                      <span className="border-l border-current opacity-30 h-4 mx-1"></span>
                      <span className={remainingTrainingHours < 0 ? "text-red-600 font-black" : ""}>
                        {remainingTrainingHours < 0 ? `เกินมา: ${Math.abs(remainingTrainingHours)} ชม.` : `คงเหลือ: ${remainingTrainingHours} ชม.`}
                      </span>
                    </div>
                  </div>
                  {/* ----------------------------- */}
                ...
                {workplaceMainTasks.map((main, mIdx) => (
                  <div key={main.id} className={`bg-slate-50 p-8 rounded-[40px] border shadow-inner relative group font-serif transition-colors ${main.isConfirmed ? 'border-green-200' : 'border-slate-100'}`}>
                    <div className={`flex flex-col md:flex-row gap-8 font-serif ${collapsedWorkplaceTasks.has(main.id) ? 'mb-0' : 'mb-10'}`}>
                      ...
                      <button onClick={() => removeWorkplaceMainTask(main.id)} className="p-3 text-slate-300 hover:text-red-500 transition self-start font-serif" title="ลบงานหลักนี้ทิ้ง">
                        <Trash2 size={24} />
                      </button>
                    </div>
                  ...
                  {subjects.filter(s => s.isAnalyzed).map((sub, idx) => {
                    ...
                    return (
                      <div key={`dve0402-${sub.id}`} className="page-break mb-20 font-serif">
                        <div className="dve-inline-code text-right text-[10pt] mb-1 border-2 border-black p-1 px-3 w-fit ml-auto font-bold">
                          DVE-04-02
                        </div>
                                  ...
                                  {mtIdx === 0 && stIdx === 0 && (
                                    <>
                                      ...
                                      <td rowSpan={totalSubTasks} className="border border-black p-2 align-top leading-relaxed">
                                        {formatNumberedText(sub.competencies, true)}
                                      </td>
                    ...
                    {(() => {
                      ...
                      workplaceMainTasks
                        .filter(mt =>
                          mt?.name &&
                          String(mt.name).trim() &&
                          Array.isArray(mt.subTasks) &&
                          mt.subTasks.some(st => st?.workplaceName && String(st.workplaceName).trim())
                        )
                        .forEach((mt, mIdx) => {
                          const safeMainName = cleanWorkplaceTaskName(cleanTaskName(mt.name));
                          rightList.push({ level: 0, text: `${mIdx + 1}. ${safeMainName}` });

                          (mt.subTasks || [])
                            .filter(st => st?.workplaceName && String(st.workplaceName).trim())
                            .forEach((st, sIdx) => {
                              let allIds = [];
                              ...
                              const uniqueIds = [...new Set(
                                allIds.map(i => i.trim().toUpperCase()).filter(Boolean)
                              )].join(', ');

                              const shortWorkplaceName = cleanWorkplaceTaskName(cleanTaskName(st.workplaceName));

                              rightList.push({
                                level: 1,
                                text: `${mIdx + 1}.${sIdx + 1} ${shortWorkplaceName}`,
                                hours: st.hours,
                          ...
                          <thead>
                            <tr className="bg-slate-100 font-bold text-center font-serif">
                              ...
                              {activeSubjects.map((s) => (
                                <th key={s.id} className="border border-black w-12 p-0 align-middle">
                                  <div className="vertical-text mx-auto text-[9pt]">
                                    {s.code || s.id}
                                  </div>
                                </th>
                              ))}
                ...
                <div id="dve-0405-area" className={`Section2 ${activeReportView !== 'dve0405' ? 'hidden' : ''}`}>
                  <div className="page-break mb-20 font-serif border-t-2 pt-10 border-dashed border-slate-300">
                    ...
                    <div className="report-header font-serif text-[11pt] space-y-1.5">
                      ...
                      <p>ฝึกงานปีการศึกษา {config.academicYear || '.........'} ระหว่างวันที่ {config.startDate || '.........'} ถึง วันที่ {config.endDate || '.........'} เวลาฝึก {totalAssignedHours > 0 ? Number((totalAssignedHours / (config.hoursPerDay || 8)).toFixed(1)) : 0} วัน / {totalAssignedHours} ชั่วโมง</p>                      {!isWorkplaceTrainer && (
                        <div>
                          <p className="font-bold">
                            ผลลัพธ์การเรียนรู้ระดับรายวิชาที่นำไปฝึกในสถานประกอบการ:
                          </p>

                          {analyzedSubjectLearningOutcomes.length > 0 ? (
                            <div className="mt-2 space-y-3">
                              {analyzedSubjectLearningOutcomes.map((subject, index) => (
                                <div key={subject.id} className="ml-4">
                                  <p className="font-bold">
                                    {index + 1}. รายวิชา {subject.name || `วิชา ${subject.id}`}
                                  </p>
                                  <div className="ml-5">
                                    {formatNumberedText(subject.learningOutcomes)}
                                  </div>
                                </div>
                              ))}
                            </div>
                    ...
                    {/* เพิ่ม table-fixed ที่ tag table เพื่อจำกัดความกว้างตารางไม่ให้ล้น */}
                    <table className="w-full table-fixed border-collapse border-2 border-black mb-8 text-[10pt] font-serif">
                      <thead>
                        <tr className="bg-slate-50 font-bold text-center font-serif">
                          {/* กำหนดสัดส่วนเปอร์เซ็นต์ให้แต่ละคอลัมน์ชัดเจน เพื่อป้องกันการโดนบีบหรือขยายเกินไป */}
                          <th className="border border-black p-2 w-[15%]">อาชีพ / ตำแหน่งงานที่ฝึก</th>
                          <th className="border border-black p-2 w-[25%]">งานหลักในสถานประกอบการ</th>
                          <th className="border border-black p-2 w-[35%]">งานย่อยในสถานประกอบการ</th>
                          <th className="border border-black p-2 w-[15%]">ชื่อ-สกุล ครูฝึก</th>
                          <th className="border border-black p-2 w-[10%]">เวลาฝึก (วัน/ชม.)</th>
                        </tr>
                      </thead>
                      <tbody>
                        {workplaceMainTasks.map((main, mIdx) => {
                          const subTasks = main.subTasks || [];
                          const rowSpan = subTasks.length > 0 ? subTasks.length : 1;
                          const displaySubTasks = subTasks.length > 0 ? subTasks : [{ workplaceName: '-', hours: 0 }];

                          return displaySubTasks.map((sub, sIdx) => (
                            <tr key={`${mIdx}-${sIdx}`} className="font-serif align-top">
                              {/* ผสานเซลล์ อาชีพ และ งานหลัก ให้แสดงแค่บรรทัดแรกของหมวดนั้น */}
                              {sIdx === 0 && (
                                <>
                                  <td className="border border-black p-2 text-center align-top break-words" rowSpan={rowSpan}>
                                    {config.occupation || '-'}
                                  </td>
                                  <td className="border border-black p-2 align-top break-words" rowSpan={rowSpan}>
                                    {mIdx + 1}. {cleanTaskName(main.name)}
                                  </td>
                                </>
                              )}

                              {/* งานย่อย จะแสดงทุกบรรทัด พร้อมรันเลขลำดับ 1.1, 1.2 */}
                              <td className="border border-black p-2 font-bold align-top break-words">
                                {sub.workplaceName !== '-' ? `${mIdx + 1}.${sIdx + 1} ${cleanTaskName(sub.workplaceName)}` : '-'}
                              </td>

                              {/* ผสานเซลล์ ชื่อครูฝึก ให้แสดงแค่บรรทัดแรก */}
                              {sIdx === 0 && (
                                <td className="border border-black p-2 text-center align-top break-words" rowSpan={rowSpan}>
                                  {config.trainerName || '-'}
                                </td>
                              ...
                              {/* เวลาฝึก แสดงทุกบรรทัดตามงานย่อย */}
                              <td className="border border-black p-2 text-center font-bold align-top break-words">
                                {sub.hours ? (
                        ...
                        {/* --- เริ่มต้น ส่วนที่เพิ่มใหม่: กิจกรรมเสริมหลักสูตร --- */}
                        {(() => {
                          let activityHours = 0;
                          // กำหนดชั่วโมงตามระดับชั้น
                          if (config.level === 'ปวส.') {
                            activityHours = 30;
                          } else if (config.level === 'ปวช.') {
                            activityHours = 36;
                          } else {
                            activityHours = 36; // ค่าเริ่มต้นเผื่อกรณีเลือก ปวช. และ ปวส. 
                          }

                          const activityDays = Number((activityHours / (config.hoursPerDay || 8)).toFixed(1));

                          return (
                            <tr className="font-serif align-top bg-blue-50/30">
                              <td className="border border-black p-2 text-center align-top break-words">
                                -
                              </td>
                              <td className="border border-black p-2 align-top break-words font-bold">
                                กิจกรรมเสริมหลักสูตร
                              </td>
                              <td className="border border-black p-2 align-top break-words">
                                <span className="font-bold">กิจกรรมในสถานประกอบการ</span><br />
                                <span className="text-[9pt] text-slate-600">(บูรณาการร่วมกับสถานประกอบการ ไม่น้อยกว่า 2 ชั่วโมง/สัปดาห์)</span>
                              </td>
                              <td className="border border-black p-2 text-center align-top break-words">
                                {config.trainerName || '-'}
                              </td>
                  ...
                  <div className="page-break font-serif">
                    {workplaceTasksFlat.map((task, idx) => (
                      <div key={idx} className="mb-20 border-2 border-black p-6 font-serif">
                        ...
                        <table className="w-full table-fixed text-[9pt] border-collapse border-2 border-black font-serif">
                          <colgroup>
                            <col style={{ width: "4%" }} />
                            <col style={{ width: "32%" }} />
                            <col style={{ width: "24%" }} />
                          ...
                          <thead>
                            <tr className="bg-slate-100 font-bold text-center font-serif">
                              <th className="border border-black p-1" rowSpan="2">ที่</th>
                              <th className="border border-black p-1" rowSpan="2">ขั้นตอนการปฏิบัติงาน</th>
                              <th className="border border-black p-1" rowSpan="2">จุดประสงค์เชิงพฤติกรรม</th>
                            ...
                            <tr className="bg-slate-50 font-bold text-center text-[7pt] font-serif">
                              ...
                              <th className="border border-black p-0.5">S</th>
                              <th className="border border-black p-0.5">A</th>
                              <th className="border border-black p-0.5">Ap</th>
                            </tr>
                          </thead>

                          <tbody>
                            {(() => {
                              const steps = Array.isArray(task.detailed_steps) ? task.detailed_steps : [];
                              const objectiveRows = Array.isArray(task.objectiveRows)
                                ? task.objectiveRows.filter(row =>
                                  row?.stage ||
                                  row?.objective ||
                                  row?.domain ||
                              ...
                              const isNewFo2Format = task.fo2Version === 2 && objectiveRows.length > 0;
                              ...
                              if (isNewFo2Format) {
                                return objectiveRows.map((row, si) => (
                                  <tr key={si} className="align-top leading-tight font-serif">
                                    ...
                                    <td className="border border-black p-2 font-bold leading-relaxed">
                                      <p className="mb-1">{row.stage || "-"}</p>

                                      {Array.isArray(row.steps) && row.steps.length > 0 && (
                                        <div className="mt-2 font-normal">
                                          {row.steps.map((stepText, stepIdx) => (
                                            <p key={stepIdx} className="mb-1">
                                              {si + 1}.{stepIdx + 1} {stepText}
                                            </p>
                                          ))}
                                        </div>
                                      )}
                          ...
                          {(() => {
                            ...
                            const filteredTasks = subjectSubTasks.filter(st => {
                              return workplaceTasksFlat.some(wt => {
                                ...
                                const safeStId = String(st.id || '').toUpperCase();
                                return ids.includes(safeStId) || stepIds.includes(safeStId);
                              });
                            });
            ...
            <div className="bg-indigo-600 p-8 rounded-3xl text-white shadow-xl flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto">
                <button
                  ...
                  className="bg-white text-indigo-600 px-8 py-4 rounded-2xl font-black text-sm hover:bg-indigo-50 shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2"
                >
                  {isDeveloper && editingCloudId ? <><Edit size={20} /> อัปเดตทับข้อมูลเดิม</> : <><Cloud size={20} /> แชร์ข้อมูลเข้าคลังส่วนกลาง</>}
                </button>
                {!editingCloudId && currentUserRole !== 'ครูฝึกในสถานประกอบการ' && (
                  <button onClick={shareToVecHub} className="bg-emerald-600 text-white px-8 py-4 rounded-2xl font-black text-sm hover:bg-emerald-700 shadow-lg active:scale-95 transition-all w-full md:w-auto flex items-center justify-center gap-2 mt-4 md:mt-0">
                    <Library size={20} /> แชร์เข้าคลังอาชีวศึกษา (เต็มรูปแบบ)
                  </button>
                )}
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto space-y-8 animate-in slide-in-from-bottom-5 duration-500 font-serif">
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm font-serif">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {(!filterProvince && searchQuery.trim() === '') ? (
                  <div className="col-span-full py-20 text-center text-slate-500 flex flex-col items-center gap-4 bg-slate-50 rounded-3xl border border-slate-100 shadow-inner">
                    <Search size={48} className="text-indigo-300" />
                    <p className="text-lg font-bold">
                      กรุณาพิมพ์ชื่อสถานประกอบการ หรือเลือกจังหวัด<br />เพื่อค้นหางานของสถานประกอบการ
                    </p>
                  </div>
                ) : cloudData.length === 0 ? (
                  ...
                  (() => {
                    const filteredData = cloudData.filter(item => {
                      const matchProv = filterProvince === '' || item.province === filterProvince;
                      const matchQuery = searchQuery === '' ||
                        item.companyName?.toLowerCase().includes(searchQuery.toLowerCase()) ||
                        (item.mainTaskSummary || "").toLowerCase().includes(searchQuery.toLowerCase());
                    ...
                    if (filteredData.length === 0) {
                      return (
                        <div className="col-span-full py-16 text-center text-slate-400 font-bold flex flex-col items-center gap-2">
                          ...
                          ไม่พบข้อมูลสถานประกอบการที่ท่านค้นหา
                        </div>
                      );
                    }
                      ...
                      <div key={item.id || idx} className={`bg-slate-50 border rounded-2xl p-5 hover:shadow-md transition-shadow group flex flex-col h-full relative ${item.deleteRequest ? 'border-orange-300 bg-orange-50/50' : 'border-slate-200'}`}>
                        <div className="flex-1">
                          <div className="flex items-start justify-between gap-2 mb-3">
                            ...
                            <button
                              onClick={() => { setDeleteModalItem(item); setDeleteTargetHub('cloud'); }}
                          ...
                          <div className="mb-4 bg-indigo-50/50 p-3 rounded-xl border border-indigo-100 shadow-inner">
                            <div className="flex items-center gap-1.5 mb-1.5">
                              <Briefcase size={14} className="text-indigo-500" />
                              <span className="text-[10px] font-black text-indigo-400 uppercase tracking-tighter">งานหลักที่จัดฝึก:</span>
                            </div>
                            <p className="text-xs font-bold text-indigo-700 line-clamp-2 leading-relaxed" title={item.mainTaskSummary}>
                              {item.mainTaskSummary || "ไม่ได้ระบุรายละเอียดงาน"}
                            </p>
                          </div>
        ...
        {activeTab === 'courseLibrary' && (
          <div className="max-w-6xl mx-auto space-y-6 font-serif">
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
              <div className="flex flex-col md:flex-row justify-between gap-4 border-b pb-6 mb-6">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    วิทยาลัย: {currentUserCollege || 'ผู้ดูแลระบบ'}
                  </p>
                </div>
              ...
              {isLoadingCourseLibrary ? (
                <div className="py-16 flex justify-center text-indigo-600">
                ...
                <div className="space-y-8">
                  {Object.entries(
                    courseLibraryData
                      .filter(item => {
                        const query = courseLibrarySearch.trim().toLowerCase();
                      ...
                      .reduce((groups, item) => {
                        const key = `${item.college || 'ไม่ระบุวิทยาลัย'}||${item.department || 'ไม่ระบุแผนก'}`;
                        if (!groups[key]) groups[key] = [];
                        groups[key].push(item);
                        return groups;
                      }, {})
                  ).map(([groupKey, items]) => {
                    const [college, department] = groupKey.split('||');
                    ...
                    return (
                      <section key={groupKey}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                          {items.map((item) => {
                            const itemKey = getCourseLibraryItemKey(item);
                            const isSelected = selectedCourseLibraryIds.includes(itemKey);

                            const isOwner =
                              String(item.creatorEmail || '').toLowerCase() ===
                            ...
                            return (
                              <div
                                key={itemKey}
                                onClick={() => toggleCourseLibrarySelection(itemKey)}
                                className={`border rounded-2xl p-5 flex flex-col cursor-pointer transition-all ${isSelected
                              ...
                              >
                                <div className="flex justify-between gap-3">
                                  <div className="flex items-start gap-3">
                                    <input
                                      type="checkbox"
                                      checked={isSelected}
                                      onChange={() => toggleCourseLibrarySelection(itemKey)}
                                  ...
                                  {canDelete && (
                                    <button
                                      onClick={(event) => {
                                        ...
                                        deleteSharedCourse(item);
                                      }}
                                      disabled={deletingCourseId === item.id}
                                      className="text-red-400 hover:text-red-600 p-1"
                                      title={isOwner ? 'ลบข้อมูลของฉัน' : 'ลบข้อมูลในฐานะแอดมิน'}
                                    >
                                      {deletingCourseId === item.id
                                        ? <Loader2 size={18} className="animate-spin" />
                                        : <Trash2 size={18} />
                                      }
                                    </button>
                                ...
                                <div className="mt-4 text-xs text-slate-500 space-y-1 flex-1">
                                  <p>งานหลัก: {subject.mainTasks?.length || 0} งาน</p>
                                  <p>ผู้แชร์: {item.creatorName || item.creatorEmail || '-'}</p>
                                </div>
                                ...
                                <button
                                  ...
                                  className="mt-5 w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-xl text-xs font-black flex justify-center items-center gap-2"
                                >
                                  <DownloadCloud size={15} />
                                  {isSelected && selectedCourseLibraryIds.length >= 2
                                    ? `นำเข้าที่เลือก (${selectedCourseLibraryIds.length})`
                                    : 'โหลดมาใช้งาน'}
                                </button>
                              </div>
                  ...
                  {!courseLibraryData.length && (
                    <div className="py-16 text-center text-slate-400">
                      ยังไม่มีรายวิชาที่แชร์ในวิทยาลัยนี้
                    </div>
                  )}
                </div>
              )}
        ...
        {pendingCourseImportItems.length > 0 && (
          <div className="fixed inset-0 z-[9999] bg-slate-900/70 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl p-6 font-serif">
              <div className="flex items-start justify-between gap-4 border-b pb-4 mb-4">
                <div>
                  <h3 className="text-xl font-black text-indigo-900 flex items-center gap-2">
                    <DownloadCloud size={22} />
                    ยืนยันการนำเข้ารายวิชา
                  </h3>
                  <p className="text-sm text-slate-500 mt-1">
                    รายวิชาที่เลือกทั้งหมด {pendingCourseImportItems.length} วิชา
                  </p>
                </div>

                <button
                  type="button"
                  onClick={() => setPendingCourseImportItems([])}
              ...
              <div className="max-h-80 overflow-y-auto space-y-2 pr-1">
                {pendingCourseImportItems.map(item => (
                  <div
                    key={getCourseLibraryItemKey(item)}
                    className="bg-slate-50 border border-slate-200 rounded-xl p-3"
                  >
                    <p className="text-xs font-black text-indigo-600">
                      {item.subject?.code || 'ไม่ระบุรหัส'}
                    </p>
                    <p className="font-black text-slate-800">
                      {item.subject?.name || 'ไม่ระบุชื่อวิชา'}
                    </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-6">
                ...
                <button
                  type="button"
                  onClick={confirmImportCourseLibraryItems}
                  className="flex-1 py-3 rounded-2xl bg-indigo-600 text-white font-black hover:bg-indigo-700 flex items-center justify-center gap-2"
                >
        ...
        {/* VEC HUB TAB (คลังแผนฝึกอาชีพอาชีวศึกษา) */}
        {activeTab === 'vechub' && (
          <div className="max-w-6xl mx-auto space-y-8 animate-in slide-in-from-bottom-5 duration-500 font-serif">
            <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm font-serif">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 border-b border-slate-100 pb-6">
                <div>
                  <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
                    <Library className="text-emerald-500" /> คลังแผนฝึกอาชีพอาชีวศึกษา
                  </h2>
                  <p className="text-sm text-slate-500 mt-1">คลังแผนฝึกจำแนกตาม วิทยาลัย สาขาวิชา และสถานประกอบการ</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="ค้นหาวิทยาลัย, สาขา, สถานประกอบการ..."
                      className="w-full sm:w-72 pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-emerald-500"
                      value={searchQuery}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {vecHubData.length === 0 ? (
                  <div className="col-span-full py-16 text-center text-slate-400 font-bold flex flex-col items-center gap-2">
                    {searchQuery ? <AlertCircle size={32} className="mb-2" /> : <Loader2 className="animate-spin mb-2" size={32} />}
                    {searchQuery ? "ไม่พบข้อมูลที่ค้นหา" : "กำลังโหลดข้อมูลคลังอาชีวศึกษา..."}
                  </div>
                ) : (
                  vecHubData.filter(item =>
                    searchQuery === '' ||
                    ...
                    <div key={item.id || idx} className="bg-slate-50 border border-slate-200 rounded-2xl p-5 hover:border-emerald-300 transition-colors flex flex-col h-full">
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-2 mb-2">
                          <h3 className="font-black text-emerald-900 text-lg leading-tight pr-6 line-clamp-2" title={item.company}>{item.company || 'ไม่ระบุชื่อบริษัท'}</h3>
                          <button
                            onClick={() => { setDeleteModalItem(item); setDeleteTargetHub('vechub'); }}
                        ...
                        <div className="space-y-1.5 mb-4">
                          <p className="text-xs font-bold text-slate-700 flex items-start gap-1.5"><Building2 size={14} className="text-indigo-500 mt-0.5 shrink-0" /> <span className="line-clamp-2">{item.college || 'ไม่ระบุวิทยาลัย'}</span></p>
                          <p className="text-xs font-bold text-slate-600 flex items-center gap-1.5"><BookOpen size={14} className="text-orange-500" /> {item.major || 'ไม่ระบุสาขา'}</p>
                          <p className="text-xs font-bold text-slate-600 flex items-center gap-1.5"><MapPin size={14} className="text-rose-500" /> {item.province || 'ไม่ระบุจังหวัด'}</p>
                          <p className="text-[10px] text-slate-400 flex items-center gap-1.5 mt-2"><User size={12} /> {item.creator}</p>
                        </div>
                      </div>
                      <div className="mt-auto pt-4 border-t border-slate-200">
                        <button
                          onClick={() => handleVecHubImport(item)}
                          className="w-full bg-emerald-100 hover:bg-emerald-200 text-emerald-700 py-2 rounded-xl text-xs font-black transition-colors flex justify-center items-center gap-1 shadow-sm"
                        >
                          <Wand2 size={14} /> นำเข้าแผนฝึก (รายวิชา + งานบริษัท)
                        </button>
                      </div>
                    </div>
                  ))
      ...
      <footer className={`text-center text-[10px] py-8 border-t mt-8 pb-24 lg:pb-8 font-serif transition-colors duration-500 ${activeTab === 'cloud' ? 'bg-slate-900 border-slate-800 text-slate-400' : 'bg-white border-slate-200 text-slate-500'}`}>
        <p className="font-bold">© 2026 สุกฤษฏิ์พล โชติอรรฐพล. All Rights Reserved.</p>
        <p className="mt-1">ระบบวิเคราะห์และจัดทำแผนฝึกอาชีพ(ระบบทวิภาคี)</p>
      </footer>
