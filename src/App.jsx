              ...
              <div className="bg-white p-10 rounded-3xl border border-slate-200 shadow-sm">
                ...
                <div className="space-y-6 mb-8">
                  {[
                    ...
                    { key: 'time', label: '6. ช่วยลดระยะเวลาที่ใช้ในการจัดทำแผนฝึก' },
                    { key: 'student', label: '7. ประโยชน์ที่นักศึกษาได้รับจากการใช้งานระบบนี้' },
                    { key: 'college', label: '8. ประโยชน์ที่สถานศึกษาได้รับจากการใช้งานระบบนี้' }
                  ].map((q, idx) => (
