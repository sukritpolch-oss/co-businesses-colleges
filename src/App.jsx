                    ...
                    {sub.isAnalyzed && (
                      <div className="flex items-center gap-2 animate-in zoom-in duration-500">
                        ...
                        <button
                          ...
                          className="text-indigo-600 hover:text-indigo-800 p-2 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition-colors disabled:opacity-50"
                          title="แชร์เข้าสู่คลังงานรายวิชา"
                        >
