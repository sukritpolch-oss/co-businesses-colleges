                      ...
                      <tbody>
                        {workplaceTasksFlat.map((t, i) => (
                          <tr key={i} className="font-serif">
                            {/* เติมคลาส break-words เข้าไปในทุกๆ td เพื่อให้ข้อความยาวๆ ตัดบรรทัดอัตโนมัติ */}
                            <td className="border border-black p-2 text-center break-words">{config.occupation || '-'}</td>
                            <td className="border border-black p-2 break-words">{cleanTaskName(t.parentMainTaskName)}</td>
                            <td className="border border-black p-2 font-bold break-words">{cleanTaskName(t.workplaceName)}</td>
                            <td className="border border-black p-2 text-center break-words">{config.trainerName || '-'}</td>
                            <td className="border border-black p-2 text-center font-bold break-words">
